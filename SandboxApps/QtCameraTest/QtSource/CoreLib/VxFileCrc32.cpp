//============================================================================
/// Public Domain
/// Based on public domain code I got somewhere.. probably www.codeguru.com
//============================================================================

#include "config_corelib.h"

#include "VxFileCrc32.h"
#include "VxDebug.h"
#include "VxDefs.h"
...
public:
	CCrc32Static2();
	virtual ~CCrc32Static2();

	static unsigned long StringCrc32( char * szString, unsigned long &dwCrc32);
	static unsigned long FileCrc32( char * szFilename, unsigned long &dwCrc32);
...
unsigned long VxCalculateFileCheckSum( const char * pFileName, uint32_t& dwCrc32 )
{
	...
	unsigned long retValue = gCrc32.FileCrc32( (char *)pFileName, dwCrc32Tmp );
	dwCrc32 = dwCrc32Tmp;
	return retValue;
}
...
// Static CRC table
unsigned long CCrc32Static2::s_arrdwCrc32Table[256] =
{
...
//***********************************************
unsigned long CCrc32Static2::StringCrc32( char * szString, unsigned long &dwCrc32)
{
	vx_assert(szString);
...
//***********************************************
unsigned long CCrc32Static2::FileCrc32( char * szFilename, unsigned long &dwCrc32)
{
	vx_assert(szFilename);
	vx_assert(strlen(szFilename));
	...
	if( NULL == hFile )
		dwErrorCode = VxGetLastError();
	else
	{
		unsigned char buffer[MAX_BUFFER_SIZE];
		unsigned long dwBytesRead, dwLoop;
		dwBytesRead = (unsigned long)fread( buffer, 1, sizeof(buffer),  hFile );
		while( dwBytesRead )
		{
