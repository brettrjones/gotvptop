...
namespace webrtc {
	...
	// will vx_assert if any method is called on an invalid thread.
	//
	...
	public:
		...
		void					fromGuiOnCacheRecordDirectBufferAddress(JNIEnv* env, jobject byte_buffer);
		...
		void					fromGuiOnDataIsRecorded(int length);

	private:
		// Raw pointer to the audio manger.
		AudioManager&			m_AudioManager;
		AudioRecordJavaClass *	m_AudioRecordJavaClass;
		jobject					m_AudioRecordJavaObject;

		// Contains audio parameters provided to this class at construction by the
		// AudioManager.
		const AudioParameters&	m_AudioParameters;
