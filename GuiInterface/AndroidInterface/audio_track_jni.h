...
namespace webrtc {
	...
	public:
		...
		void					fromGuiOnCachePlayoutDirectBufferAddress(JNIEnv* env, jobject byte_buffer);
		...
		void					fromGuiOnGetPlayoutData(size_t length);

	private:
		AudioManager&			m_AudioManager;
		AudioTrackJavaClass *	m_AudioTrackJavaClass;
		jobject					m_AudioTrackJavaObject;
