...
{
    return m_RenderLogic.m_RenderGlShaders.enableShader( method );
}

//============================================================================
bool RenderGlWidget::isShaderValid( ESHADERMETHOD method )
{
    return m_RenderLogic.m_RenderGlShaders.isShaderValid( method );
}

//============================================================================
void RenderGlWidget::disableShader( ESHADERMETHOD method )
{
    m_RenderLogic.m_RenderGlShaders.disableShader( method );
}

//============================================================================
void RenderGlWidget::disableGUIShader()
{
    m_RenderLogic.m_RenderGlShaders.disableGUIShader();
}

//============================================================================
int RenderGlWidget::shaderGetPos( )
{
    return m_RenderLogic.m_RenderGlShaders.shaderGetPos();
}

//============================================================================
int RenderGlWidget::shaderGetCol()
{
    return m_RenderLogic.m_RenderGlShaders.shaderGetCol();
}

//============================================================================
int RenderGlWidget::shaderGetModel()
{
    return m_RenderLogic.m_RenderGlShaders.shaderGetModel();
}

//============================================================================
int RenderGlWidget::shaderGetCoord0()
{
    return m_RenderLogic.m_RenderGlShaders.shaderGetCoord0();
}

//============================================================================
int RenderGlWidget::shaderGetCoord1()
{
    return m_RenderLogic.m_RenderGlShaders.shaderGetCoord1();
}

//============================================================================
int RenderGlWidget::shaderGetUniCol()
{
    return m_RenderLogic.m_RenderGlShaders.shaderGetUniCol();
}
...
{
    return m_RenderLogic.m_RenderGlShaders.shaderGetTextureFilter( shader, filter );
}
...
{
    return m_RenderLogic.m_RenderGlShaders.shaderVertexAttribPointer( shader, index, size, type, normalized, stride, pointer );
}

//============================================================================
void RenderGlWidget::shaderEnableVertexAttribArray( ESHADERMETHOD shader, int arrayId )
{
    m_RenderLogic.m_RenderGlShaders.shaderEnableVertexAttribArray( shader, arrayId );
}

//============================================================================
void RenderGlWidget::shaderDisableVertexAttribArray( ESHADERMETHOD shader, int arrayId )
{
    m_RenderLogic.m_RenderGlShaders.shaderDisableVertexAttribArray( shader, arrayId );
}
