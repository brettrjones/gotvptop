...
//============================================================================
PlayerGlWidget::PlayerGlWidget(QWidget *parent)
: QWidget(parent)
...
//============================================================================
MyIcons&  PlayerGlWidget::getMyIcons( void )
{
	return m_MyApp.getMyIcons();
}

//============================================================================
VxLabel * PlayerGlWidget::getVideoScreen( void )
{
...
//============================================================================
void PlayerGlWidget::setAspectRatio( float aspectRatio )
{
    //ui.m_VideoFrame->setVideoScreenAspectRatio( aspectRatio );
}

//============================================================================
void PlayerGlWidget::setVideoFeedId( VxGUID& feedOnlineId )				
{ 
...
//============================================================================
void PlayerGlWidget::showOfflineImage( void )
{
	//ui.m_VideoScreen->setImageFromFile( ":/AppRes/Resources/web_cam_buffering.png" );
}

//============================================================================
void PlayerGlWidget::showUserMsgLabel( bool showCtrls )
{
    ui.m_UserMsgLabel->setVisible( showCtrls );
}

//============================================================================
void PlayerGlWidget::showAllControls( bool showCtrls )
{
...
//============================================================================
void PlayerGlWidget::enableVidFilesButton( bool enable )
{
	ui.m_VidFilesButton->setEnabled( enable );
}

//============================================================================
void PlayerGlWidget::enableCamSourceControls( bool enable )
{
...
//============================================================================
void PlayerGlWidget::enableCamFeedControls( bool enable )
{
	ui.m_ImageRotateButton->setEnabled( enable );
}

//============================================================================
void PlayerGlWidget::showFeedControls( bool showCtrls )
{
	ui.m_VidCtrlFrame->setVisible( showCtrls );
}

//============================================================================
bool PlayerGlWidget::isFeedControlsVisible( void )
{
	return ui.m_VidCtrlFrame->isVisible();
}

//============================================================================
void PlayerGlWidget::showRecordControls( bool showCtrls )
{
...
//============================================================================
bool PlayerGlWidget::isRecordControlsVisible( void )
{
	return ui.m_RecordCtrlFrame->isVisible();
}

//============================================================================
void PlayerGlWidget::showMotionSensitivityControls( bool showCtrls )
{
	ui.m_RecordSensitivityFrame->setVisible( showCtrls );
}

//============================================================================
bool PlayerGlWidget::isMotionSensitivityControlsVisible( void )
{
	return ui.m_RecordSensitivityFrame->isVisible();
}

//============================================================================
void PlayerGlWidget::setVidImageRotation( int imageRotation )
{
	//ui.m_VideoScreen->setVidImageRotation( imageRotation );
}

//============================================================================
int PlayerGlWidget::getVidImageRotation( void )
{
...
//============================================================================
void PlayerGlWidget::slotStatusMsg( QString userMsg )
{
	ui.m_UserMsgLabel->setText( userMsg );
}

//============================================================================
void PlayerGlWidget::slotWidgetClicked( void )
{
	emit clicked();
...
//============================================================================
void PlayerGlWidget::slotCamPreviewButtonClicked( void )
{
	if( !m_DisablePreview )
	{
...
//============================================================================
void PlayerGlWidget::updatePreviewVisibility( void )
{
...
//============================================================================
void PlayerGlWidget::slotFeedRotateButtonClicked( void )
{
...
//============================================================================
void PlayerGlWidget::updateVidFeedImageRotation( void )
{
	int feedRotation = m_AppSettings.getVidFeedRotation();
...
//============================================================================
void PlayerGlWidget::slotCamRotateButtonClicked( void )
{
...
//============================================================================
void PlayerGlWidget::disablePreview( bool disable )
{
...
//============================================================================
void PlayerGlWidget::setImageFromFile( QString fileName )
{
	//ui.m_VideoScreen->setImageFromFile( fileName );
}

//============================================================================
void PlayerGlWidget::playVideoFrame( VxGUID&	feedOnlineId, unsigned char * pu8Jpg, unsigned long u32JpgLen, int motion0To100000 )
{
    /*
	if( feedOnlineId == m_VideoFeedId )
	{
...
//============================================================================
int PlayerGlWidget::playVideoFrame( VxGUID& feedOnlineId, uint8_t * picBuf, uint32_t picBufLen, int picWidth, int picHeight )
{
...
//============================================================================
void PlayerGlWidget::showEvent( QShowEvent * ev )
{
...
//============================================================================
void PlayerGlWidget::hideEvent( QHideEvent * ev )
{
...
//============================================================================
void PlayerGlWidget::slotMotionAlarmTimeout( void )
{
...
//============================================================================
void PlayerGlWidget::slotMotionRecordTimeout( void )
{
...
//============================================================================
void PlayerGlWidget::slotVidFeedMotion( int motion0To100000 )
{
...
//============================================================================
void PlayerGlWidget::updateMotionBarColor( void )
{
...
//============================================================================
void PlayerGlWidget::playMotionAlarm( void )
{
	m_MyApp.playSound( eSndDefAlarmPleasant );
}

//============================================================================
void PlayerGlWidget::slotVidFilesButtonClicked( void )
{
	if( !m_MotionRecordOn
		&& !m_InNormalRecord )
	{
	...
	{
		LogMsg( LOG_ERROR, "PlayerGlWidget::slotVidFilesButtonClicked dont launch Library Activity while recording\n" );
	}
}

//============================================================================
void PlayerGlWidget::slotPictureSnapshotButton( void )
{
	QImage photoImage = getVideoScreen()->getLastVideoImage();
	if( photoImage.isNull() )
	{
		m_MyApp.playSound( eSndDefIgnore );
		LogMsg( LOG_ERROR, "PlayerGlWidget::slotPictureSnapshotButton video image is null\n" );
...
//============================================================================
void PlayerGlWidget::slotMotionAlarmButtonClicked( void )
{
	if( m_MotionAlarmOn )
	{
		m_MotionAlarmExpireTimer->stop();
...
//============================================================================
void PlayerGlWidget::slotRecMotionButtonClicked( void )
{
	if( !m_InNormalRecord )
	{
		if( !m_RecFilePath.isEmpty() )
		{
			...
			if( m_MotionRecordOn )
			{
				...
				if( 5000 > fileLen )
				{
					...
					LogMsg( LOG_ERROR, "PlayerGlWidget::videoMotionRecord file %s has to short len %lld\n", m_RecFileName.toUtf8().constData(), fileLen );
...
//============================================================================
void PlayerGlWidget::slotRecNormalButtonClicked( void )
{
	if( !m_MotionRecordOn )
	{
		if( !m_RecFilePath.isEmpty() )
		{
			if( m_InNormalRecord )
			{
				...
				if( 5000 > fileLen )
				{
					// not long enough to be a recording
					VxFileUtil::deleteFile( m_RecFileName.toUtf8().constData() );
					LogMsg( LOG_ERROR, "PlayerGlWidget::videoRecord file %s has to short len %lld\n", m_RecFileName.toUtf8().constData(), fileLen );
