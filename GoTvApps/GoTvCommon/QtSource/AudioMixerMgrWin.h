...
private:
    ...
    int32_t						m_id;
    HMIXER						m_outputMixerHandle;
    UINT						m_outputMixerID;
    HMIXER						m_inputMixerHandle;
    UINT						m_inputMixerID;
    SpeakerLineInfo				m_speakerState[MAX_NUMBER_MIXER_DEVICES];
    MicrophoneLineInfo			m_microphoneState[MAX_NUMBER_MIXER_DEVICES];
    mutable char				m_str[MAXERRORLENGTH];
};
