...
//============================================================================
LauncherPage::LauncherPage( AppCommon& app, QWidget * parent )
...
//============================================================================
void LauncherPage::setTitle( QString strTitle )
{
	ui.popupTitleLabel->setText(strTitle);
}

//============================================================================
void LauncherPage::addMenuItem( int iItemId, QIcon& oIcon, QString strMenuItemText )
{
...
void LauncherPage::slotHomeButtonClicked( void )
{
	m_MyApp.playSound( eSndDefButtonClick );
	close();
}
...
//============================================================================
void LauncherPage::itemClicked(QListWidgetItem *item)
{
	m_MyApp.playSound( eSndDefButtonClick );
...
//============================================================================
void LauncherPage::showRefreshMenu()
{
...
//============================================================================
void LauncherPage::showFriendMenu( VxNetIdent * poSelectedFriend )
{
...
void LauncherPage::onFriendActionSelected( int iMenuId, QWidget * )
{
	switch( iMenuId )
	{
