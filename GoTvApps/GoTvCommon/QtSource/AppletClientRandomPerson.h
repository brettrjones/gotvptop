...
#include "ui_AppletClientRandomPerson.h"

#include "AppletClientBase.h"
#include <GoTvInterface/IDefs.h>
#include <GoTvInterface/IToGui.h>

class AppletClientRandomPerson : public AppletClientBase
{
	Q_OBJECT
public:
	AppletClientRandomPerson( AppCommon& app, QWidget * parent );
	virtual ~AppletClientRandomPerson() override;
