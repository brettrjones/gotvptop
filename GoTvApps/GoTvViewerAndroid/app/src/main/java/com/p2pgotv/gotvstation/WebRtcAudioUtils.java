...
{
	private static final String LOG_TAG = "WebRtcAudioUtils";
	...
	{ "Nexus 10", "Nexus 9", "ONE A2005", // OnePlus 2
	};
	...
	public static synchronized boolean useWebRtcBasedAutomaticGainControl()
	{
		...
		{
			Log.w( LOG_TAG,
					"Overriding default behavior; now using WebRTC AGC!" );
		}
	...
	public static synchronized boolean useWebRtcBasedNoiseSuppressor()
	{
		...
		{
			Log.w( LOG_TAG, "Overriding default behavior; now using WebRTC NS!" );
		}
	...
	{
		List<String> blackListedModels = Arrays
				.asList( BLACKLISTED_OPEN_SL_ES_MODELS );
	...
	public static void logDeviceInfo( String tag )
	{
		Log.d( tag, "Android SDK: " + Build.VERSION.SDK_INT + ", "
				+ "Release: " + Build.VERSION.RELEASE + ", " + "Brand: "
				+ Build.BRAND + ", " + "Device: " + Build.DEVICE + ", "
				+ "Id: " + Build.ID + ", " + "Hardware: " + Build.HARDWARE
