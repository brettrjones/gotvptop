...
public class VxColorPickerSquare extends View {
	Paint paint;
	Shader luar;
	final float[] color = { 1.f, 1.f, 1.f };

	public VxColorPickerSquare(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public VxColorPickerSquare(Context context, AttributeSet attrs, int defStyle) {
