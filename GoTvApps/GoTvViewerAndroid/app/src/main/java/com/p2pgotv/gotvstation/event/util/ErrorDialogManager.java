package com.p2pgotv.gotvstation.event.util;
...
public class ErrorDialogManager {
    ...
    protected static final String TAG_ERROR_DIALOG = "com.p2pgotv.gotvstation.eventbus.error_dialog";
    protected static final String TAG_ERROR_DIALOG_MANAGER = "com.p2pgotv.gotvstation.eventbus.error_dialog_manager";

    public static final String KEY_TITLE = "com.p2pgotv.gotvstation.eventbus.errordialog.title";
    public static final String KEY_MESSAGE = "com.p2pgotv.gotvstation.eventbus.errordialog.message";
    public static final String KEY_FINISH_AFTER_DIALOG = "com.p2pgotv.gotvstation.eventbus.errordialog.finish_after_dialog";
    public static final String KEY_ICON_ID = "com.p2pgotv.gotvstation.eventbus.errordialog.icon_id";
    public static final String KEY_EVENT_TYPE_ON_CLOSE = "com.p2pgotv.gotvstation.eventbus.errordialog.event_type_on_close";
