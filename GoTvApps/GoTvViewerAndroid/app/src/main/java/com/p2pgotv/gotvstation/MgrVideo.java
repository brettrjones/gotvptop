...
OnPreparedListener, OnVideoSizeChangedListener, SurfaceHolder.Callback, OnErrorListener 
{
   ...
   // private int					m_iResourceId = 0;
    ...
    private void DoPlayVideo(int iResourceId, SurfaceHolder oHolder ) 
    {
        ...
        try 
        {
        	AssetFileDescriptor fd = m_MyApp.getResources().openRawResourceFd(iResourceId);
        	if( null != fd)
        	{
