...
public class ActivityViewAudioFile  extends ActivityBase implements AssetCallbackInterface
{
	//=== constants ===//
    ...
    {
        setContentView(R.layout.activity_view_audio_file);
        super.onCreate(savedInstanceState);
        setPageTitle( R.string.activity_view_audio_file_title );
		...
		m_VxFileInfo = new VxFileInfo( m_FileName, fileLen, Constants.VXFILE_TYPE_AUDIO, null );
