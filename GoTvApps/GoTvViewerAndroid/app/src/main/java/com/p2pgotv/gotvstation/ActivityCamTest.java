...
public class ActivityCamTest extends Activity 
{
    ...
    static final private String LOG_TAG 						= "CamCapture:";
	//=== vars ===//
	public 	MyApp 				m_MyApp 			= null;
    TextView 					mTextStatusHistory;

    //========================================================================
    public ActivityCamTest() 
    {
    }
    ...
    private class CameraTestRunner extends AsyncTask<Integer, String, Void> {
        ...
        {
        	Log.d(LOG_TAG, "camera.setPreviewCallbackWithBuffer null " );
            camera.setPreviewCallbackWithBuffer(null);
        	Log.d(LOG_TAG, "camera.setPreviewCallbackWithBuffer catcher + buffers " );
        ...
        protected void TestCamera(int whichCamera,
            ...
            Log.v(LOG_TAG, "Camera.open " + whichCamera );
            ...
            try {
                try {
                    ...
                    //} else {
                        Log.v(LOG_TAG, "Camera.setPreviewDisplay previewView.mHolder " );
                ...
                Log.v(LOG_TAG, "Camera.setPreviewCallbackWithBuffer null " );
                camera.setPreviewCallbackWithBuffer(null);
                ...
                Log.v(LOG_TAG, "Camera.setParameters width " + width + " height " + height + " fps " + frameRate );
                ...
                int numPasses = 1;
                boolean doSetDisplayOrientation = false;
                /*
                ...
                */
                ...
                for (int i = 0; i < numPasses; i++) {
                    ...
                    //}
                	Log.d(LOG_TAG, "camera.startPreview() " );  
                    camera.startPreview();
                    try {
                        Thread.sleep(5000);
