...
/**
 * An ImageSpan representing an embedded video.
 */
public class VideoSpan extends MediaSpan 
{
	//============================================================================
    public VideoSpan( RTVideo video, boolean isSaved, boolean isRelativePath, String rootPath ) 
    {
        super( video, isSaved, isRelativePath, rootPath );
    }
