...
package com.p2pgotv.gotvstation.rteditor.media.choose;
...
import com.p2pgotv.gotvstation.rteditor.media.MonitoredActivity;
import com.p2pgotv.gotvstation.rteditor.media.choose.AudioChooserManager.AudioChooserListener;
import com.p2pgotv.gotvstation.rteditor.media.choose.ImageChooserManager.ImageChooserListener;
import com.p2pgotv.gotvstation.rteditor.media.choose.VideoChooserManager.VideoChooserListener;
import com.p2pgotv.gotvstation.rteditor.media.crop.CropImageActivity;
    ...
    public void onImageChosen(final RTImage image) 
    {
        ...
        {	
        	...
        	if( ( null != rootPath ) && ( ! rootPath.isEmpty() ) )
        	{
                ...
                if( ( imagePath.length() >= rootPath.length() ) 
                	&& !rootPath.isEmpty()
                ...
                else
                {
                    ...
                    String destPathAndName = rootPath + image.getFileName();
                    ...
                    {
                    	String justFileName = VxFileUtil.getJustFileName( destPathAndName );
                    	image.setFilePath( justFileName);
        ...
        runOnUiThread(new Runnable() 
        {
            ...
            public void run() 
            {
                ...
                {
                    String filePath = mSelectedMedia.getFilePath(RTFormat.SPANNED);
