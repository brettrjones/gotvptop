...
public class ActivityTestIsMyPortOpen extends ActivityBase 
{
	// === constants ===//
	public static final String LOG_TAG = "ActivityTestIsMyPortOpen:";
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_test_is_my_port_open);
		super.onCreate(savedInstanceState);
		setPageTitle( R.string.activity_test_is_my_port_open_title );

		Log.d(LOG_TAG, "m_LogText");
		this.m_LogText = (EditText) this.findViewById(R.id.is_my_port_open_test_log);

		Log.d(LOG_TAG, "m_oTestBut");
		this.m_oTestBut = (Button) this.findViewById(R.id.is_my_port_open_test_button );
		...
		m_MyApp.m_oActTestIsMyPortOpen = this;
		onTestButClick();
	}
	...
	public void onBackButtonPressed() 
	{
		...
		m_MyApp.m_oActTestIsMyPortOpen = null; 
	...
	//========================================================================
	//========================================================================
	public void toGuiIsPortOpenStatus( String strMsgIn ) 
	{
		try 
		{
