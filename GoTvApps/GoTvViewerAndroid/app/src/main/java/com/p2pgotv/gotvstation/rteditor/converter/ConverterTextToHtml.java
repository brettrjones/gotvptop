...
public class ConverterTextToHtml {
    ...
    public static RTHtml<RTImage, RTAudio, RTVideo> convert( String rootPath, RTPlainText input) 
    {
        String text = input.getText();
        String result = convert(text);
        return new RTHtml<RTImage, RTAudio, RTVideo>( rootPath, RTFormat.HTML, result);
    }
