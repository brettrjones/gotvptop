...
class UploadsAdapter extends ArrayAdapter<GuiOfferSession> 
{	
	//=== constants ===//
	private static final String LOG_TAG = "UploadsAdapter:";  
	...
	//=== methods ===//
	public UploadsAdapter(MyApp context, int textViewResourceId, ArrayList<GuiOfferSession> items) 
    {
