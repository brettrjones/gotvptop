...
public class ActivityAnchorSettings  extends ActivityBase implements OnItemSelectedListener
{
	//=== constants ===//
	public static final String LOG_TAG = "ActivityAnchorSetttings:";
	...
	private Button 				m_VerifySettingsBut 		= null;
	private Button 				m_ManageSettingsBut 		= null;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setPageTitle( R.string.activity_anchor_settings_title);
	    ...
	    this.m_SettingsNameAdaper		= new ArrayAdapter<String>(ActivityAnchorSettings.this,android.R.layout.simple_dropdown_item_1line,m_SettingsNameList);
	    ...
	    this.m_VerifySettingsBut = (Button)this.findViewById(R.id.anchor_settings_verify_button);
	 	this.m_VerifySettingsBut.setOnClickListener(new OnClickListener() 
	 	{
	 		public void onClick(View v) 
	 		{
        		m_MyApp.playButtonClick();
	 			onVerifySettingsButClick(v);
	 		}
	 	});	

	    this.m_ManageSettingsBut = (Button)this.findViewById(R.id.anchor_settings_manage_button);
	 	this.m_ManageSettingsBut.setOnClickListener(new OnClickListener() 
	 	{
	 		public void onClick(View v) 
	 		{
        		m_MyApp.playButtonClick();
	 			onManageSettingsButClick(v);
	 		}
	 	});	
  ...
  //============================================================================
    ...
    void updateSettingsFromDlg()
    {
    	...
    	g_oMySettings.setNetworkName( anchorSetting.getNetworkName() );
  	    ...
  	    if( ( null != anchorSetting.getAnchorSettingName() ) && ( 0 != anchorSetting.getAnchorSettingName().length() ) )
  	    {
    ...
    //========================================================================
  	public void fillAnchorSettingFromDialog( AnchorSetting anchorSetting )
  	{
	    	...
	    	anchorSetting.setNetServiceWebsiteUrl( strValue );		
  	   	...
  	   	{
  			Toast.makeText( this, R.string.no_anchor_setting_selected, Toast.LENGTH_SHORT ).show();
  	   	}
	}
    
    //========================================================================
  	public void onVerifySettingsButClick(View v) 
    {
    	updateSettingsFromDlg();
    	m_MyApp.sendNetworkSettingsToNative();
     	Log.i( LOG_TAG, "onVerifySettingsButClick " );
 		Intent myIntent = new Intent(ActivityAnchorSettings.this, ActivityTestAnchorSettings.class);
 		ActivityAnchorSettings.this.startActivityForResult(myIntent, Constants.ACTIVITY_TEST_ANCHOR_SETTINGS );		 		
 	}  	
    
    //========================================================================
  	public void onManageSettingsButClick(View v) 
    {
    	updateSettingsFromDlg();
     	Log.i(LOG_TAG, "onManageSettingsButClick ");	
 		Intent myIntent = new Intent(ActivityAnchorSettings.this, ActivityManageAnchorSettings.class);
 		ActivityAnchorSettings.this.startActivityForResult(myIntent, Constants.ACTIVITY_MANAGE_ANCHOR_SETTINGS );		 		
 	}
	...
	{
		if( Constants.ACTIVITY_MANAGE_ANCHOR_SETTINGS == requestCode )
		{
			updateDlgFromSettings();
		}
	}
