...
package com.p2pgotv.gotvstation.rteditor.converter;

import com.p2pgotv.gotvstation.Constants;
...
import com.p2pgotv.gotvstation.rteditor.spans.UnderlineSpan;

import com.p2pgotv.gotvstation.rteditor.api.format.RTFormat;
import com.p2pgotv.gotvstation.rteditor.api.format.RTHtml;
...
import com.p2pgotv.gotvstation.rteditor.converter.tagsoup.util.StringEscapeUtils;
import com.p2pgotv.gotvstation.rteditor.spans.AudioSpan;
import com.p2pgotv.gotvstation.rteditor.spans.BoldSpan;
import com.p2pgotv.gotvstation.rteditor.spans.TypefaceSpan;
import com.p2pgotv.gotvstation.rteditor.spans.ImageSpan;
import com.p2pgotv.gotvstation.rteditor.spans.ItalicSpan;
import com.p2pgotv.gotvstation.rteditor.spans.LinkSpan;
import com.p2pgotv.gotvstation.rteditor.spans.VideoSpan;
import com.p2pgotv.gotvstation.rteditor.utils.Helper;
import com.p2pgotv.gotvstation.rteditor.utils.Paragraph;
import com.p2pgotv.gotvstation.rteditor.utils.RTLayout;
...
{
	private static final String LOG_TAG =	"HtmlEditor:";
     ...
     */
    public RTHtml<RTImage, RTAudio, RTVideo> convert( String rootPath, final Spanned text, RTFormat.Html rtFormat) 
    {
        mText 			= text;
        mRTFormat 		= rtFormat;
        ...
        return new RTHtml<RTImage, RTAudio, RTVideo>( rootPath, rtFormat, mOut.toString(), mImages );
    }
    ...
    //========================================================================
    static public String formatImageHtmlWithDesiredWidth( String filePath, int imageWidth, int imageHeight )
    {
    	double imageScale = (double)Constants.IMAGE_DESIRED_WIDTH / (double)imageWidth;
    	int finalHeight = (int)(imageScale * imageHeight);
    	String strHeight = String.valueOf( finalHeight );
    	
    	String htmlEntry = "<img src=\"" + filePath + "\" " + " width=\"320\" height=\"" + strHeight + "\">";
    	return htmlEntry;
    }
    ...
    private boolean handleStartTag(CharacterStyle style) 
    {
		...
		*/
        ...
        else if (style instanceof ImageSpan) 
        {
            ...
            //span.setRelativePath( rootDirPath )
            	...
            	&& ( 0 != image.getHeight() ) )
            {
	        	...
	        	Log.d( LOG_TAG, "ConverterSpannedToHtml:ImageSpan " + filePath );
	        	if( image.getWidth() != Constants.IMAGE_DESIRED_WIDTH )
	            {
	        		String imageHtml = formatImageHtmlWithDesiredWidth( filePath, image.getWidth(), image.getHeight() );
	            	mOut.append( imageHtml );
	            }
	            else
	            {
            ...
            {
            	mOut.append("<img src=\"" + filePath + "\">");  // default for missing image    
            	Log.d( LOG_TAG, "ConverterSpannedToHtml:Default ImageSpan " + filePath );
            }
