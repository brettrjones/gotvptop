...
public class VxMultiGestureDetector 
{
	...
	private VxOnMultiGestureListener listener;
	
	//========================================================================
	public VxMultiGestureDetector(float screenDensity) 
	{
		touch = new TouchProcessor(screenDensity);
	}

	//========================================================================
	public VxOnMultiGestureListener getListener() 
	{
		return listener;
	}

	//========================================================================
	public void setListener(VxOnMultiGestureListener listener) 
	{
	...
	//========================================================================
	// TODO: make distance threshold based on pixel density information!
