...
import com.p2pgotv.gotvstation.rteditor.utils.io.FilenameUtils;
...
{
    private static final long serialVersionUID = 5098840799124458005L;
    ...
    //============================================================================
    @Override
    public void setFilePath( String filePathAndName ) 
    {
    ...
    public boolean exists( String rootPath ) 
    {
        ...
        if( null != mFilePath )
        {
        	fileExists = new File( mFilePath ).exists();
        	if( false == fileExists )
        	{
        		fileExists = new File( rootPath + mFilePath ).exists();
        	}
        }
    ...
    public long getSize( String rootPath ) 
    {
        if( mFilePath != null ) 
        {
        	...
        	{
           		file = new File( rootPath + mFilePath );
           		return file.length();
        	}
