...
public class VxColorPickerDialog 
{
	public interface VxOnColorPickerListener 
	{
		void onCancel(VxColorPickerDialog dialog);
		void onOk(VxColorPickerDialog dialog, int color);
	}

	final AlertDialog dialog;
	private final boolean supportsAlpha;
	final VxOnColorPickerListener listener;
	final View viewHue;
	final VxColorPickerSquare viewSatVal;
	 ...
	 */
	public VxColorPickerDialog(final Context context, int color, VxOnColorPickerListener listener) 
	{
	 ...
	 * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
	 */
	public VxColorPickerDialog(final Context context, int color, boolean supportsAlpha, VxOnColorPickerListener listener) 
	{
		...
		final View view = LayoutInflater.from(context).inflate(R.layout.vx_color_picker_dialog, null);
		viewHue = view.findViewById(R.id.ambilwarna_viewHue);
		viewSatVal = (VxColorPickerSquare) view.findViewById(R.id.ambilwarna_viewSatBri);
		...
		if (supportsAlpha) viewAlphaCheckered.setOnTouchListener(new View.OnTouchListener() 
		{
			...
			public boolean onTouch(View v, MotionEvent event) 
			{
				...
				|| (event.getAction() == MotionEvent.ACTION_UP)) 
				{
					...
					VxColorPickerDialog.this.setAlpha(a);

					// update view
					moveAlphaCursor();
					int col = VxColorPickerDialog.this.getColor();
		...
		.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				...
				if (VxColorPickerDialog.this.listener != null) {
					VxColorPickerDialog.this.listener.onOk(VxColorPickerDialog.this, getColor());
					if (viewOldColor != null) {
						viewOldColor.setBackgroundColor(getColor());
					}
				}
			}
		})
		.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				...
				if (VxColorPickerDialog.this.listener != null) 
				{
					VxColorPickerDialog.this.listener.onCancel(VxColorPickerDialog.this);
				}
			}
		})
		...
		vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() 
		{
			...
			{
				moveCursor();
				if (VxColorPickerDialog.this.supportsAlpha) moveAlphaCursor();
				moveTarget();
				if (VxColorPickerDialog.this.supportsAlpha) updateAlphaView();
