...
//============================================================================
RenderGlLogic::RenderGlLogic( const QSurfaceFormat &format )
: m_format(format)
{
...
void RenderGlLogic::glWidgetInitialized( QOpenGLContext * widgetGlContext )
{

}

//============================================================================
void RenderGlLogic::setAnimating( RenderGlWidget* window, bool animating )
{
    ...
    if (animating) {
        m_windows << window;
        if (m_windows.size() == 1)
            QTimer::singleShot(0, this, &RenderGlLogic::render);
    } else {
        m_currentWindow = 0;
...
void RenderGlLogic::render()
{
    ...
    RenderGlWidget * renderWidget = m_windows.at(m_currentWindow);
    if( renderWidget )
    {
...
void RenderGlLogic::createGeometry()
{
    vertices.clear();
    normals.clear();
...
void RenderGlLogic::quad(qreal x1, qreal y1, qreal x2, qreal y2, qreal x3, qreal y3, qreal x4, qreal y4)
{
...
void RenderGlLogic::extrude(qreal x1, qreal y1, qreal x2, qreal y2)
{
    vertices << QVector3D(x1, y1, +0.05f);
    vertices << QVector3D(x2, y2, +0.05f);
    vertices << QVector3D(x1, y1, -0.05f);
...
//============================================================================
bool RenderGlLogic::initRenderSystem()
{
    return false;
}

//============================================================================
bool RenderGlLogic::destroyRenderSystem()
{
    return false;
}

//============================================================================
bool RenderGlLogic::resetRenderSystem( int width, int height )
{
    return false;
}

//============================================================================
bool RenderGlLogic::beginRender()
{
    return false;
}

//============================================================================
bool RenderGlLogic::endRender()
{
    return false;
}

//============================================================================
void RenderGlLogic::presentRender( bool rendered, bool videoLayer )
{
