...
class RenderGlLogic : public QObject, protected QOpenGLFunctions
{
    Q_OBJECT
public:
    explicit RenderGlLogic( const QSurfaceFormat &format );
    ...
    void                        setAnimating( RenderGlWidget* window, bool animating );
...
private:
    ...
    QList<RenderGlWidget *>     m_windows;
