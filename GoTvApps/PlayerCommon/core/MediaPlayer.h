...
#ifndef GOTVQT_MEDIAPLAYER_H_
#define GOTVQT_MEDIAPLAYER_H_
...
public:
    ...
    */
    ...
    /*!
        ...
        \return libgotvptop media player (libgotvptop_media_player_t *)
    */
    libgotvptop_media_player_t *core() const;
    ...
    */
    ...
    /*!
        ...
        \return media core object (libgotvptop_media_t *)
    */
    libgotvptop_media_t *currentMediaCore();
...
public:
    ...
    */
    ...
    /*!
        \brief Get sample aspect ratio for current video track( gotvptop >= 2.1.0 ).
...
signals:
    ...
    */
    void mediaChanged(libgotvptop_media_t *media);
