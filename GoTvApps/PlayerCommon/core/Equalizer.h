...
#ifndef GOTVQT_EQUALIZER_H_
#define GOTVQT_EQUALIZER_H_
...
public slots:
    ...
    /*!
        ...
        The new equalizer settings are subsequently applied to a media player by invoking libgotvptop_media_player_set_equalizer().
