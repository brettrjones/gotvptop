...
#ifdef _MSC_VER
static __declspec( align( 32 ) ) uint8_t eos_mpeg[ 184 ] =
#else
...
#ifdef _MSC_VER
static __declspec( align( 32 ) ) uint8_t eos_avc_vc1[ 184 ] =
#else
...
#ifdef _MSC_VER
static __declspec( align( 32 ) ) uint8_t eos_vc1_spmp_link[ 32 ] =
#else
...
#ifdef _MSC_VER
static __declspec( align( 32 ) ) uint8_t eos_divx[ 184 ] =
#else
...
#ifdef _MSC_VER
static __declspec( align( 32 ) ) uint8_t btp_video_done_es_private[ ] =
#else
...
#ifdef _MSC_VER
static __declspec( align( 32 ) ) uint8_t btp_video_done_es[] =
#else
...
#ifdef _MSC_VER
static __declspec( align( 32 ) ) uint8_t ExtData[] =
#else
    ...
    )
{
    ...
    drvHandle =open_os(CRYSTALHD_API_DEV_NAME, O_RDWR);
    if(drvHandle < 0)
    {
