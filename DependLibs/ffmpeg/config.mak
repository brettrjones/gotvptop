...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=mingw32 --prefix=/xbmc/lib/win32/ffmpeg --arch=x86 --disable-static --enable-shared --disable-debug --disable-doc --enable-gpl --enable-gnutls --enable-w32threads --enable-shared --enable-memalign-hack --enable-postproc --enable-zlib --disable-static --disable-programs --disable-devices --disable-avdevice --disable-crystalhd --enable-muxer=spdif --enable-muxer=adts --enable-muxer=asf --enable-muxer=ipod --enable-encoder=ac3 --enable-encoder=aac --enable-encoder=wmav2 --enable-encoder=png --enable-encoder=mjpeg --enable-protocol=http --enable-runtime-cpudetect --disable-dxva2 --cpu=i686 --extra-cflags=-DPTW32_STATIC_LIB --extra-ldflags=-static-libgcc
prefix=/xbmc/lib/win32/ffmpeg
...
CC_IDENT=gcc 5.3.0 (Rev1, Built by MSYS2 project)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-I/local32/include -D_FORTIFY_SOURCE=2 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DZLIB_CONST
CFLAGS=-I/local32/include -mms-bitfields -mthreads -mtune=generic -pipe  -DPTW32_STATIC_LIB -march=i686 -std=c99 -fomit-frame-pointer -I/local32/include -I/mingw32/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=-I/local32/include -mms-bitfields -mthreads -mtune=generic -pipe  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -DPTW32_STATIC_LIB -march=i686
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS=-L/local32/lib -mthreads -pipe -static-libgcc  -march=i686 -Wl,--large-address-aware -Wl,--nxcompat,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
HOSTCPPFLAGS= -D_ISOC99_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
HOSTEXESUF=.exe
HOSTLDFLAGS= 
HOSTLIBS=-lm
DEPHOSTCC=gcc
...
EXTRALIBS=-lws2_32 -lsecur32 -L/local32/lib -L/mingw32/lib -lgnutls -lnettle -lhogweed -lcrypt32 -lws2_32 -lz -lgmp -lintl -liconv -lz -lintl -liconv -lws2_32 -liconv -lws2_32 -lgmp -lhogweed -lgmp -lnettle -ltasn1 -lz -lm -llzma -lbz2 -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
