...
#if TEMPLATE_PP_C // do not compile directly.. this file is only date included in other c files
...
#endif // TEMPLATE_PP_C // do not compile directly.. this file is only date included in other c files
