...
#define AV_CONST(name, help, val, unit) { name, help, 0, AV_OPT_TYPE_CONST, {.i64=val}, 0, 0, FLAGS, unit }
...
static const AVOption minterpolate_options[] = {
    ...
    { "mi_mode", "motion interpolation mode", OFFSET(mi_mode), AV_OPT_TYPE_INT, {.i64 = MI_MODE_MCI}, MI_MODE_DUP, MI_MODE_MCI, FLAGS, "mi_mode" },
        AV_CONST("dup",    "duplicate frames",                     MI_MODE_DUP,            "mi_mode"),
        AV_CONST("blend",  "blend frames",                         MI_MODE_BLEND,          "mi_mode"),
        AV_CONST("mci",    "motion compensated interpolation",     MI_MODE_MCI,            "mi_mode"),
    { "mc_mode", "motion compensation mode", OFFSET(mc_mode), AV_OPT_TYPE_INT, {.i64 = MC_MODE_OBMC}, MC_MODE_OBMC, MC_MODE_AOBMC, FLAGS, "mc_mode" },
        AV_CONST("obmc",   "overlapped block motion compensation", MC_MODE_OBMC,           "mc_mode"),
        AV_CONST("aobmc",  "adaptive overlapped block motion compensation", MC_MODE_AOBMC, "mc_mode"),
    { "me_mode", "motion estimation mode", OFFSET(me_mode), AV_OPT_TYPE_INT, {.i64 = ME_MODE_BILAT}, ME_MODE_BIDIR, ME_MODE_BILAT, FLAGS, "me_mode" },
        AV_CONST("bidir",  "bidirectional motion estimation",      ME_MODE_BIDIR,          "me_mode"),
        AV_CONST("bilat",  "bilateral motion estimation",          ME_MODE_BILAT,          "me_mode"),
    { "me", "motion estimation method", OFFSET(me_method), AV_OPT_TYPE_INT, {.i64 = AV_ME_METHOD_EPZS}, AV_ME_METHOD_ESA, AV_ME_METHOD_UMH, FLAGS, "me" },
        AV_CONST("esa",    "exhaustive search",                    AV_ME_METHOD_ESA,       "me"),
        AV_CONST("tss",    "three step search",                    AV_ME_METHOD_TSS,       "me"),
        AV_CONST("tdls",   "two dimensional logarithmic search",   AV_ME_METHOD_TDLS,      "me"),
        AV_CONST("ntss",   "new three step search",                AV_ME_METHOD_NTSS,      "me"),
        AV_CONST("fss",    "four step search",                     AV_ME_METHOD_FSS,       "me"),
        AV_CONST("ds",     "diamond search",                       AV_ME_METHOD_DS,        "me"),
        AV_CONST("hexbs",  "hexagon-based search",                 AV_ME_METHOD_HEXBS,     "me"),
        AV_CONST("epzs",   "enhanced predictive zonal search",     AV_ME_METHOD_EPZS,      "me"),
        AV_CONST("umh",    "uneven multi-hexagon search",          AV_ME_METHOD_UMH,       "me"),
    ...
    { "scd", "scene change detection method", OFFSET(scd_method), AV_OPT_TYPE_INT, {.i64 = SCD_METHOD_FDIFF}, SCD_METHOD_NONE, SCD_METHOD_FDIFF, FLAGS, "scene" },
        AV_CONST("none",   "disable detection",                    SCD_METHOD_NONE,        "scene"),
        AV_CONST("fdiff",  "frame difference",                     SCD_METHOD_FDIFF,       "scene"),
