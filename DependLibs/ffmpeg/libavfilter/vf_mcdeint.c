...
static const AVOption mcdeint_options[] = {
    ...
    VF_CONST("fast",       NULL, MODE_FAST,       "mode"),
    VF_CONST("medium",     NULL, MODE_MEDIUM,     "mode"),
    VF_CONST("slow",       NULL, MODE_SLOW,       "mode"),
    VF_CONST("extra_slow", NULL, MODE_EXTRA_SLOW, "mode"),

    { "parity", "set the assumed picture field parity", OFFSET(parity), AV_OPT_TYPE_INT, {.i64=PARITY_BFF}, -1, 1, FLAGS, "parity" },
    VF_CONST("tff", "assume top field first",    PARITY_TFF, "parity"),
    VF_CONST("bff", "assume bottom field first", PARITY_BFF, "parity"),
