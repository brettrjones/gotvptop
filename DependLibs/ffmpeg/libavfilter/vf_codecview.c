...
static const AVOption codecview_options[] = {
    { "mv", "set motion vectors to visualize", OFFSET(mv), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, INT_MAX, FLAGS, "mv" },
        AV_CONST("pf", "forward predicted MVs of P-frames",  MV_P_FOR,  "mv"),
        AV_CONST("bf", "forward predicted MVs of B-frames",  MV_B_FOR,  "mv"),
        AV_CONST("bb", "backward predicted MVs of B-frames", MV_B_BACK, "mv"),
    ...
    { "mvt",     "set motion vectors type", OFFSET(mv_type), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, INT_MAX, FLAGS, "mv_type" },
        AV_CONST("fp", "forward predicted MVs",  MV_TYPE_FOR,  "mv_type"),
        AV_CONST("bp", "backward predicted MVs", MV_TYPE_BACK, "mv_type"),
    ...
    { "ft",         "set frame types to visualize motion vectors of", OFFSET(frame_type), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, INT_MAX, FLAGS, "frame_type" },
        AV_CONST("if", "I-frames", FRAME_TYPE_I, "frame_type"),
        AV_CONST("pf", "P-frames", FRAME_TYPE_P, "frame_type"),
        AV_CONST("bf", "B-frames", FRAME_TYPE_B, "frame_type"),
    { NULL }
};
