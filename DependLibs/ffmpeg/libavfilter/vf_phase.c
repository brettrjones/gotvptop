...
#define VF_CONST(name, help, val, unit) { name, help, 0, AV_OPT_TYPE_CONST, {.i64=val}, 0, 0, FLAGS, unit }
...
static const AVOption phase_options[] = {
    ...
    VF_CONST("p", "progressive",          PROGRESSIVE,          "mode"),
    VF_CONST("t", "top first",            TOP_FIRST,            "mode"),
    VF_CONST("b", "bottom first",         BOTTOM_FIRST,         "mode"),
    VF_CONST("T", "top first analyze",    TOP_FIRST_ANALYZE,    "mode"),
    VF_CONST("B", "bottom first analyze", BOTTOM_FIRST_ANALYZE, "mode"),
    VF_CONST("u", "analyze",              ANALYZE,              "mode"),
    VF_CONST("U", "full analyze",         FULL_ANALYZE,         "mode"),
    VF_CONST("a", "auto",                 AUTO,                 "mode"),
    VF_CONST("A", "auto analyze",         AUTO_ANALYZE,         "mode"),
    { NULL }
};
