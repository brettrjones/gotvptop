...
#ifdef FFMPEG_CONFIG_H // BRJ do not compile directly.. data file included by other files
...
#endif // FFMPEG_CONFIG_H // BRJ do not compile directly.. data file included by other files
