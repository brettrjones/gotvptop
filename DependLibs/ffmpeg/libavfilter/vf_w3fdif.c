...
static const AVOption w3fdif_options[] = {
    ...
    VF_CONST("simple",  NULL, 0, "filter"),
    VF_CONST("complex", NULL, 1, "filter"),
    { "deint",  "specify which frames to deinterlace", OFFSET(deint), AV_OPT_TYPE_INT, {.i64=0}, 0, 1, FLAGS, "deint" },
    VF_CONST("all",        "deinterlace all frames",                       0, "deint"),
    VF_CONST("interlaced", "only deinterlace frames marked as interlaced", 1, "deint"),
    { NULL }
};
