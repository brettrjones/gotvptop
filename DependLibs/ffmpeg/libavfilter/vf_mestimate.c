...
static const AVOption mestimate_options[] = {
    { "method", "motion estimation method", OFFSET(method), AV_OPT_TYPE_INT, {.i64 = AV_ME_METHOD_ESA}, AV_ME_METHOD_ESA, AV_ME_METHOD_UMH, FLAGS, "method" },
        AV_CONST("esa",   "exhaustive search",                  AV_ME_METHOD_ESA,      "method"),
        AV_CONST("tss",   "three step search",                  AV_ME_METHOD_TSS,      "method"),
        AV_CONST("tdls",  "two dimensional logarithmic search", AV_ME_METHOD_TDLS,     "method"),
        AV_CONST("ntss",  "new three step search",              AV_ME_METHOD_NTSS,     "method"),
        AV_CONST("fss",   "four step search",                   AV_ME_METHOD_FSS,      "method"),
        AV_CONST("ds",    "diamond search",                     AV_ME_METHOD_DS,       "method"),
        AV_CONST("hexbs", "hexagon-based search",               AV_ME_METHOD_HEXBS,    "method"),
        AV_CONST("epzs",  "enhanced predictive zonal search",   AV_ME_METHOD_EPZS,     "method"),
        AV_CONST("umh",   "uneven multi-hexagon search",        AV_ME_METHOD_UMH,      "method"),
