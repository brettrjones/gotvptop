...
#if (CONFIG_PRORES_DECODER || CONFIG_PRORES_LGPL_DECODER) && ARCH_X86_64 && HAVE_X86_ASM
...
#endif
#if CONFIG_MPEG4_DECODER && HAVE_X86_ASM
#if ARCH_X86_32
...
#endif
#endif /* CONFIG_MPEG4_DECODER && HAVE_X86_ASM */
#if (CONFIG_PRORES_DECODER || CONFIG_PRORES_LGPL_DECODER) && ARCH_X86_64 && HAVE_X86_ASM
