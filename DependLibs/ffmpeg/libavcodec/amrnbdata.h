...
#include "libavutil/avutil_common.h"      /* offsetof */
...
enum Mode {
	...
	// NOTE: NO_DATA conflicts with windows winsock2 defines.. renamed to MODE_NO_TRANSMISSION
    //NO_DATA = 15
	MODE_NO_TRANSMISSION = 15///< no transmission
};
