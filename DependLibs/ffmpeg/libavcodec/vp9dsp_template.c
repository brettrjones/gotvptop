...
#define VP9_IN(x) ((dctint) in[(x) * stride])
                                      ...
                                      dctcoef *out, int pass)
{
    ...
    t0 = ((VP9_IN(0) + VP9_IN(2)) * 11585 + (1 << 13)) >> 14;
    t1 = ((VP9_IN(0) - VP9_IN(2)) * 11585 + (1 << 13)) >> 14;
    t2 = (VP9_IN(1) *  6270 - VP9_IN(3) * 15137 + (1 << 13)) >> 14;
    t3 = (VP9_IN(1) * 15137 + VP9_IN(3) *  6270 + (1 << 13)) >> 14;
                                       ...
                                       dctcoef *out, int pass)
{
    ...
    t0 =  5283 * VP9_IN(0) + 15212 * VP9_IN(2) +  9929 * VP9_IN(3);
    t1 =  9929 * VP9_IN(0) -  5283 * VP9_IN(2) - 15212 * VP9_IN(3);
    t2 = 13377 * (VP9_IN(0) - VP9_IN(2) + VP9_IN(3));
    t3 = 13377 * VP9_IN(1);
                                      ...
                                      dctcoef *out, int pass)
{
    ...
    t0a = ((VP9_IN(0) + VP9_IN(4)) * 11585 + (1 << 13)) >> 14;
    t1a = ((VP9_IN(0) - VP9_IN(4)) * 11585 + (1 << 13)) >> 14;
    t2a = (VP9_IN(2) *  6270 - VP9_IN(6) * 15137 + (1 << 13)) >> 14;
    t3a = (VP9_IN(2) * 15137 + VP9_IN(6) *  6270 + (1 << 13)) >> 14;
    t4a = (VP9_IN(1) *  3196 - VP9_IN(7) * 16069 + (1 << 13)) >> 14;
    t5a = (VP9_IN(5) * 13623 - VP9_IN(3) *  9102 + (1 << 13)) >> 14;
    t6a = (VP9_IN(5) *  9102 + VP9_IN(3) * 13623 + (1 << 13)) >> 14;
    t7a = (VP9_IN(1) * 16069 + VP9_IN(7) *  3196 + (1 << 13)) >> 14;
                                       ...
                                       dctcoef *out, int pass)
{
    ...
    t0a = 16305 * VP9_IN(7) +  1606 * VP9_IN(0);
    t1a =  1606 * VP9_IN(7) - 16305 * VP9_IN(0);
    t2a = 14449 * VP9_IN(5) +  7723 * VP9_IN(2);
    t3a =  7723 * VP9_IN(5) - 14449 * VP9_IN(2);
    t4a = 10394 * VP9_IN(3) + 12665 * VP9_IN(4);
    t5a = 12665 * VP9_IN(3) - 10394 * VP9_IN(4);
    t6a =  4756 * VP9_IN(1) + 15679 * VP9_IN(6);
    t7a = 15679 * VP9_IN(1) -  4756 * VP9_IN(6);
                                       ...
                                       dctcoef *out, int pass)
{
    ...
    t0a  = ((VP9_IN(0) + VP9_IN(8)) * 11585 + (1 << 13)) >> 14;
    t1a  = ((VP9_IN(0) - VP9_IN(8)) * 11585 + (1 << 13)) >> 14;
    t2a  = (VP9_IN(4)  *  6270 - VP9_IN(12) * 15137 + (1 << 13)) >> 14;
    t3a  = (VP9_IN(4)  * 15137 + VP9_IN(12) *  6270 + (1 << 13)) >> 14;
    t4a  = (VP9_IN(2)  *  3196 - VP9_IN(14) * 16069 + (1 << 13)) >> 14;
    t7a  = (VP9_IN(2)  * 16069 + VP9_IN(14) *  3196 + (1 << 13)) >> 14;
    t5a  = (VP9_IN(10) * 13623 - VP9_IN(6)  *  9102 + (1 << 13)) >> 14;
    t6a  = (VP9_IN(10) *  9102 + VP9_IN(6)  * 13623 + (1 << 13)) >> 14;
    t8a  = (VP9_IN(1)  *  1606 - VP9_IN(15) * 16305 + (1 << 13)) >> 14;
    t15a = (VP9_IN(1)  * 16305 + VP9_IN(15) *  1606 + (1 << 13)) >> 14;
    t9a  = (VP9_IN(9)  * 12665 - VP9_IN(7)  * 10394 + (1 << 13)) >> 14;
    t14a = (VP9_IN(9)  * 10394 + VP9_IN(7)  * 12665 + (1 << 13)) >> 14;
    t10a = (VP9_IN(5)  *  7723 - VP9_IN(11) * 14449 + (1 << 13)) >> 14;
    t13a = (VP9_IN(5)  * 14449 + VP9_IN(11) *  7723 + (1 << 13)) >> 14;
    t11a = (VP9_IN(13) * 15679 - VP9_IN(3)  *  4756 + (1 << 13)) >> 14;
    t12a = (VP9_IN(13) *  4756 + VP9_IN(3)  * 15679 + (1 << 13)) >> 14;
                                        ...
                                        dctcoef *out, int pass)
{
    ...
    t0  = VP9_IN(15) * 16364 + VP9_IN(0)  *   804;
    t1  = VP9_IN(15) *   804 - VP9_IN(0)  * 16364;
    t2  = VP9_IN(13) * 15893 + VP9_IN(2)  *  3981;
    t3  = VP9_IN(13) *  3981 - VP9_IN(2)  * 15893;
    t4  = VP9_IN(11) * 14811 + VP9_IN(4)  *  7005;
    t5  = VP9_IN(11) *  7005 - VP9_IN(4)  * 14811;
    t6  = VP9_IN(9)  * 13160 + VP9_IN(6)  *  9760;
    t7  = VP9_IN(9)  *  9760 - VP9_IN(6)  * 13160;
    t8  = VP9_IN(7)  * 11003 + VP9_IN(8)  * 12140;
    t9  = VP9_IN(7)  * 12140 - VP9_IN(8)  * 11003;
    t10 = VP9_IN(5)  *  8423 + VP9_IN(10) * 14053;
    t11 = VP9_IN(5)  * 14053 - VP9_IN(10) *  8423;
    t12 = VP9_IN(3)  *  5520 + VP9_IN(12) * 15426;
    t13 = VP9_IN(3)  * 15426 - VP9_IN(12) *  5520;
    t14 = VP9_IN(1)  *  2404 + VP9_IN(14) * 16207;
    t15 = VP9_IN(1)  * 16207 - VP9_IN(14) *  2404;
...
static av_always_inline void idct32_1d(const dctcoef *in, ptrdiff_t stride,
                                       dctcoef *out, int pass)
{
    dctint t0a  = ((VP9_IN(0) + VP9_IN(16)) * 11585 + (1 << 13)) >> 14;
    dctint t1a  = ((VP9_IN(0) - VP9_IN(16)) * 11585 + (1 << 13)) >> 14;
    dctint t2a  = (VP9_IN( 8) *  6270 - VP9_IN(24) * 15137 + (1 << 13)) >> 14;
    dctint t3a  = (VP9_IN( 8) * 15137 + VP9_IN(24) *  6270 + (1 << 13)) >> 14;
    dctint t4a  = (VP9_IN( 4) *  3196 - VP9_IN(28) * 16069 + (1 << 13)) >> 14;
    dctint t7a  = (VP9_IN( 4) * 16069 + VP9_IN(28) *  3196 + (1 << 13)) >> 14;
    dctint t5a  = (VP9_IN(20) * 13623 - VP9_IN(12) *  9102 + (1 << 13)) >> 14;
    dctint t6a  = (VP9_IN(20) *  9102 + VP9_IN(12) * 13623 + (1 << 13)) >> 14;
    dctint t8a  = (VP9_IN( 2) *  1606 - VP9_IN(30) * 16305 + (1 << 13)) >> 14;
    dctint t15a = (VP9_IN( 2) * 16305 + VP9_IN(30) *  1606 + (1 << 13)) >> 14;
    dctint t9a  = (VP9_IN(18) * 12665 - VP9_IN(14) * 10394 + (1 << 13)) >> 14;
    dctint t14a = (VP9_IN(18) * 10394 + VP9_IN(14) * 12665 + (1 << 13)) >> 14;
    dctint t10a = (VP9_IN(10) *  7723 - VP9_IN(22) * 14449 + (1 << 13)) >> 14;
    dctint t13a = (VP9_IN(10) * 14449 + VP9_IN(22) *  7723 + (1 << 13)) >> 14;
    dctint t11a = (VP9_IN(26) * 15679 - VP9_IN( 6) *  4756 + (1 << 13)) >> 14;
    dctint t12a = (VP9_IN(26) *  4756 + VP9_IN( 6) * 15679 + (1 << 13)) >> 14;
    dctint t16a = (VP9_IN( 1) *   804 - VP9_IN(31) * 16364 + (1 << 13)) >> 14;
    dctint t31a = (VP9_IN( 1) * 16364 + VP9_IN(31) *   804 + (1 << 13)) >> 14;
    dctint t17a = (VP9_IN(17) * 12140 - VP9_IN(15) * 11003 + (1 << 13)) >> 14;
    dctint t30a = (VP9_IN(17) * 11003 + VP9_IN(15) * 12140 + (1 << 13)) >> 14;
    dctint t18a = (VP9_IN( 9) *  7005 - VP9_IN(23) * 14811 + (1 << 13)) >> 14;
    dctint t29a = (VP9_IN( 9) * 14811 + VP9_IN(23) *  7005 + (1 << 13)) >> 14;
    dctint t19a = (VP9_IN(25) * 15426 - VP9_IN( 7) *  5520 + (1 << 13)) >> 14;
    dctint t28a = (VP9_IN(25) *  5520 + VP9_IN( 7) * 15426 + (1 << 13)) >> 14;
    dctint t20a = (VP9_IN( 5) *  3981 - VP9_IN(27) * 15893 + (1 << 13)) >> 14;
    dctint t27a = (VP9_IN( 5) * 15893 + VP9_IN(27) *  3981 + (1 << 13)) >> 14;
    dctint t21a = (VP9_IN(21) * 14053 - VP9_IN(11) *  8423 + (1 << 13)) >> 14;
    dctint t26a = (VP9_IN(21) *  8423 + VP9_IN(11) * 14053 + (1 << 13)) >> 14;
    dctint t22a = (VP9_IN(13) *  9760 - VP9_IN(19) * 13160 + (1 << 13)) >> 14;
    dctint t25a = (VP9_IN(13) * 13160 + VP9_IN(19) *  9760 + (1 << 13)) >> 14;
    dctint t23a = (VP9_IN(29) * 16207 - VP9_IN( 3) *  2404 + (1 << 13)) >> 14;
    dctint t24a = (VP9_IN(29) *  2404 + VP9_IN( 3) * 16207 + (1 << 13)) >> 14;
