...
#define frm1        0x0434 // taken from tools/dlgs.h
...
typedef struct KmvcContext {
    ...
    uint8_t  frame1[320 * 200]; // NOTE: renamed from frm1 to frame1 to avoid name clash with #define frm1        0x0434 in tools/dlgs.h
    GetByteContext g;
} KmvcContext;
