...
#ifdef TARGET_OS_WINDOWS // only available in windows
...
// windows.h must not be included before winsock2.h, and libavformat internal
...
#endif // TARGET_OS_WINDOWS // only available in windows
