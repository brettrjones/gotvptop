...
#ifdef AVRESAMPLE_MAX_CHANNELS // do not compile template directly

#include <math.h>
#include <stdint.h>

#include "libavutil/avutil_common.h"
#include "avresample_internal.h"
...
#define AV_OUT(d, v) d = av_clipl_int32((v + (1 << 29)) >> 30)
...
#define FELEML        int64_t
#define AV_OUT(d, v) d = av_clip_int16((v + (1 << 14)) >> 15)
...
#endif // AVRESAMPLE_MAX_CHANNELS // do not compile template directly
