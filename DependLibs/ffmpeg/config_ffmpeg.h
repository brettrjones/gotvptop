...
#define HAVE_OPENJPEG_2_1_OPENJPEG_H	1 // we have this but path is default
...
#define HAVE_CBRT 1
#define HAVE_CBRTF 1
//#define HAVE_COPYSIGN 1 // defined in GoTvCompilerConfig.h
#define HAVE_COSF 1
#define HAVE_ERF 1
#define HAVE_EXP2 1
#define HAVE_EXP2F 1
...
#define HAVE_POWF 1
#define HAVE_RINT 1
//#define HAVE_ROUND 1 // defined in GoTvCompilerConfig.h
...
//#define HAVE_THREADS 0 // defined in GoTvCompilerConfig.h
#define HAVE_UWP 0
#define HAVE_WINRT 0
...
//#define HAVE_FCNTL 0 // defined in GoTvCompilerConfig.h
...
//#define HAVE_GMTIME_R 0   // defined in GoTvCompilerConfig.h
...
//#define HAVE_STRUCT_POLLFD 0 // defined in GoTvCompilerConfig.h
...
#define CONFIG_VIDEOTOOLBOX 0 // APPLE tools
...
// video codex decoders ( registered in allcodecs.c )
...
// external libraries, that shouldn't be used by default if one of the above is available 
...
#define CONFIG_HAVE_ALSA_SOUND_LIB 0
#define CONFIG_HAVE_BSD_GRAB_INTERFACE 0
#define CONFIG_HAVE_CACA_CANVAS 0
#define CONFIG_HAVE_DECKLINK_VIDEO_CARD 0
#define CONFIG_HAVE_DV1394_INTERFACE 0 // Linux only
#define CONFIG_HAVE_OPEN_SOUND_SYSTEM 0
#define CONFIG_HAVE_PULSE_AUDIO 0
#define CONFIG_HAVE_SDL_LIB 0
#define CONFIG_HAVE_SNDIO_LIB 0

#ifdef TARGET_OS_WINDOWS
//# define CONFIG_USE_DIRECT_SHOW_LIB 1 // direct show is windows only
# define CONFIG_USE_DIRECT_SHOW_LIB 0 // direct show is windows only
# define CONFIG_USE_GDI_GRAB 1 // gdi is windows only
#else
# define CONFIG_USE_DIRECT_SHOW_LIB 0
# define CONFIG_USE_GDI_GRAB 0 // gdi is windows only
#endif // TARGET_OS_WINDOWS

# define CONFIG_HAVE_FBDEV_INTERFACE 0 // Linux only
# define CONFIG_HAVE_RAW_1394_INTERFACE 0 // Linux only
# define CONFIG_HAVE_JACK_INTERFACE 0 // Linux only
# define CONFIG_HAVE_CDIO_LIB 0 // Linux only
# define CONFIG_HAVE_FLITE_VOICE_SYNTH_LIB 0 
# define CONFIG_HAVE_FREI0R_LIB 0 

# define CONFIG_HAVE_LADSPA_LIB 0 // linux audio plugins 
# define CONFIG_HAVE_NETCDF_LIB 0 
# define CONFIG_HAVE_NVIDIA_CUDA_LIB 0 
# define CONFIG_HAVE_NVIDIA_NPP_LIB 0 
# define CONFIG_HAVE_OPENAL_LIB 0 // windows or linux
# define CONFIG_HAVE_OPENGL_LIB 0 // windows or linux
# define CONFIG_HAVE_OPENCL_LIB 0 
# define CONFIG_HAVE_RUBBERBAND_LIB 0 
# define CONFIG_HAVE_TESSARACT_OCR_LIB 0 
# define CONFIG_HAVE_VA_LIB 0 // android/linux video accel lib
# define CONFIG_HAVE_VID_STAB_LIB 0 
# define CONFIG_HAVE_ZIMAGE_LIB 0 
# define CONFIG_HAVE_ZMQ_LIB 0 

#define CONFIG_H264_VDA_DECODER 0


# define CONFIG_HAVE_BAUER_BINAURAL_FILTER 0 // linux audio plugins 

#define FFMPEG_USE_PROBE 0
#define FFMPEG_USE_OPT 0
#define FFMPEG_SUPPORT_DVD_PLAYER 0
#define FFMPEG_SUPPORT_MMAL_HARDWARE_DECODE 0
#define FFMPEG_SUPPORT_NVIDIA_CUDA 0
#define FFMPEG_SUPPORT_OMX 0
#define FFMPEG_SUPPORT_INTEL_MFX 0
#define FFMPEG_SUPPORT_INTEL_VA 0
#define FFMPEG_SUPPORT_APPLE_VDA 0
#define FFMPEG_SUPPORT_QSV 0
#define FFMPEG_SUPPORT_VAAPI_HWACCEL 0
#define FFMPEG_SUPPORT_VDPAU_HWACCEL 0
#define FFMPEG_SUPPORT_VIDEOTOOLBOX_HWACCEL 0
#define FFMPEG_SUPPORT_DRM_HWACCEL 0

#define FFMPEG_SUPPORT_VAAPI_HWACCEL 0 // hardware accel for intel video hardware

#define FF_API_CAP_VDPAU 1 // do not really want this hardware accel but need the defines
#define FF_API_CODEC_GET_SET 1
#define FF_API_FORMAT_GET_SET 1
#define FF_API_FORMAT_FILENAME 1 // so compatible with old filename or new url in AVFormatContext
#define FF_API_LAVF_FFSERVER 1 // so compatible with old api
#define FF_API_LOCKMGR 1 // kodi requires this api
#define FF_API_NEXT 1 // so compatible with old api
#define FF_API_R_FRAME_RATE 1 // kodi needs this for av_stream_get_r_frame_rate in DVDDemuxFFmpeg.cpp
