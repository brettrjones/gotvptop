...
#include <libxml2/schemasInternals.h>
#include <libxml2/xmlschemastypes.h>
#include <libxml2/xmlautomata.h>
#include <libxml2/xmlregexp.h>
#include <libxml2/dict.h>
#include <libxml2/encoding.h>
#include <libxml2/xmlIO.h>
#ifdef LIBXML_PATTERN_ENABLED
#include <libxml2/pattern.h>
#endif
...
#ifdef DEBUG_AUTOMATA
		xmlGenericError(xmlGenericErrorContext,
		    "AUTOMATON missing ERROR_XML2 on '%s'\n",
		    inode->localName);
#endif
	    } else {
		/*
	...
	*/
	...
	case XML_SCHEMA_CONTENT_MIXED:
	    ...
	    */
	    ...
	    if (ret < 0)
		xmlGenericError(xmlGenericErrorContext,
		"AUTOMATON push ERROR_XML2 for '%s' on '%s'\n",
