				    ...
				    NTSTATUS *presult)
{
	...
	DEBUG_OUT (10,("rpccli_samr_chgpasswd_user\n"));
				     ...
				     NTSTATUS *presult)
{
	...
	DEBUG_OUT (10,("rpccli_samr_chgpasswd_user2\n"));
					 ...
					 NTSTATUS *presult)
{
	...
	DEBUG_OUT (10,("rpccli_samr_chng_pswd_auth_crap\n"));
				     ...
				     NTSTATUS *presult)
{
	...
	DEBUG_OUT (10,("rpccli_samr_chgpasswd_user3\n"));
