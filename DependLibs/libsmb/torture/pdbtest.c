...
static bool samu_correct(struct samu *s1, struct samu *s2)
{
	...
	if (s2_buf == NULL && s1_buf != NULL) {
		DEBUG_OUT (0, ("Username is not set\n"));
		ret = False;
	} else if (s1_buf == NULL) {
		/* Do nothing */
	} else if (strcmp(s1_buf,s2_buf)) {
		DEBUG_OUT (0, ("Username not written correctly, want %s, got \"%s\"\n",
					pdb_get_username(s1),
					pdb_get_username(s2)));
		ret = False;
	}
	...
	if (s2_buf == NULL && s1_buf != NULL) {
		DEBUG_OUT (0, ("NT Username is not set\n"));
		ret = False;
	} else if (s1_buf == NULL) {
		/* Do nothing */
	} else if (strcmp(s1_buf, s2_buf)) {
		DEBUG_OUT (0, ("NT Username not written correctly, want \"%s\", got \"%s\"\n",
	...
	if (pdb_get_acct_ctrl(s1) != pdb_get_acct_ctrl(s2)) {
		DEBUG_OUT (0, ("Acct ctrl field not written correctly, want %d (0x%X), got %d (0x%X)\n",
	...
	if (d2_buf == NULL && d1_buf != NULL) {
		DEBUG_OUT (0, ("NT password is not set\n"));
		ret = False;
	} else if (d1_buf == NULL) {
		/* Do nothing */
	} else if (memcmp(d1_buf, d2_buf, NT_HASH_LEN)) {
		DEBUG_OUT (0, ("NT password not written correctly\n"));
		ret = False;
	}
	...
	if (d2_buf == NULL && d1_buf != NULL) {
		DEBUG_OUT (0, ("Lanman password is not set\n"));
	} else if (d1_buf == NULL) {
		/* Do nothing */
	} else if (memcmp(d1_buf, d2_buf, NT_HASH_LEN)) {
		DEBUG_OUT (0, ("Lanman password not written correctly\n"));
		ret = False;
	}
	...
	if (s2_buf == NULL && s1_buf != NULL) {
		DEBUG_OUT (0, ("Profile path is not set\n"));
		ret = False;
	} else if (s1_buf == NULL) {
		/* Do nothing */
	} else if (strcmp(s1_buf, s2_buf)) {
		DEBUG_OUT (0, ("Profile path is not written correctly\n"));
		ret = False;
	}
	...
	if (s2_buf == NULL && s1_buf != NULL) {
		DEBUG_OUT (0, ("Home dir is not set\n"));
		ret = False;
	} else if (s1_buf == NULL) {
		/* Do nothing */
	} else if (strcmp(s1_buf, s2_buf)) {
		DEBUG_OUT (0, ("Home dir is not written correctly\n"));
		ret = False;
	}
	...
	if (s2_buf == NULL && s1_buf != NULL) {
		DEBUG_OUT (0, ("Logon script not set\n"));
		ret = False;
	} else if (s1_buf == NULL) {
		/* Do nothing */
	} else if (strcmp(s1_buf, s2_buf)) {
		DEBUG_OUT (0, ("Logon script is not written correctly\n"));
		ret = False;
	}
