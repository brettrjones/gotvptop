...
static void smbd_smb2_request_ioctl_done(struct tevent_req *subreq)
{
	...
	DEBUG_OUT (10,("smbd_smb2_request_ioctl_done: smbd_smb2_ioctl_recv returned "
		"%u status %s\n",
					       ...
					       uint32_t in_flags)
{
	...
	DEBUG_OUT (10, ("smbd_smb2_ioctl: ctl_code[0x%08x] %s fnum[%d]\n",
	...
	case 0x0011C017: /* FSCTL_PIPE_TRANSCEIVE */
		...
		DEBUG_OUT (10,("smbd_smb2_ioctl_send: np_write_send of size %u\n",
...
static void smbd_smb2_ioctl_pipe_write_done(struct tevent_req *subreq)
{
	...
	DEBUG_OUT (10,("smbd_smb2_ioctl_pipe_write_done: received %ld\n",
		(long int)nwritten ));
	...
	DEBUG_OUT (10,("smbd_smb2_ioctl_pipe_write_done: issuing np_read_send "
		"of size %u\n",
...
static void smbd_smb2_ioctl_pipe_read_done(struct tevent_req *subreq)
{
	...
	DEBUG_OUT (10,("smbd_smb2_ioctl_pipe_read_done: np_read_recv nread = %d "
