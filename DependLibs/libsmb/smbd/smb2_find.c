...
NTSTATUS smbd_smb2_request_process_find(struct smbd_smb2_request *req)
{
	...
	DEBUG_OUT (10,("smbd_smb2_request_find_done: in_output_buffer_length = %u\n",
...
static void smbd_smb2_request_find_done(struct tevent_req *subreq)
{
	...
	DEBUG_OUT (10,("smbd_smb2_request_find_done: out_output_buffer.length = %u\n",
					      ...
					      const char *in_file_name)
{
	...
	DEBUG_OUT (10,("smbd_smb2_find_send: %s - fnum[%d]\n",
...
#define DIR_ENTRY_SAFETY_MARGIN 4096
	...
	DEBUG_OUT (8,("smbd_smb2_find_send: dirpath=<%s> dontdescend=<%s>, "
