...
static void smbd_smb2_request_notify_done(struct tevent_req *subreq)
{
	...
	if (req->cancelled) {
		...
		DEBUG_OUT (10,("smbd_smb2_request_notify_done: cancelled mid %llu\n",
						...
						uint64_t in_completion_filter)
{
	...
	DEBUG_OUT (10,("smbd_smb2_notify_send: %s - fnum[%d]\n",
...

	{
		...
		DEBUG_OUT (3,("smbd_smb2_notify_send: notify change "
