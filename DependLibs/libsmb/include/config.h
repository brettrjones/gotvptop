...
#define HAVE_LINUX_FALLOCATE64 1
...
#define STRING_STATIC_MODULES " pdb_smbpasswd pdb_tdbsam pdb_wbc_sam idmap_tdb idmap_passdb idmap_nss nss_info_template auth_sam auth_unix auth_winbind auth_wbc auth_server auth_domain auth_builtin vfs_default"
