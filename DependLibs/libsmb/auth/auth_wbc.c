				       ...
				       struct auth_serversupplied_info **server_info)
{
	...
	DEBUG_OUT (10, ("Check auth for: [%s]", user_info->mapped.account_name));
	...
	{
		DEBUG_OUT (3,("Checking plaintext password for %s.\n",
	...
	{
		DEBUG_OUT (3,("Checking encrypted password for %s.\n",
			 user_info->mapped.account_name));
	...
	case AUTH_PASSWORD_HASH:
	{
		DEBUG_OUT (3,("Checking logon (hash) password for %s.\n",
			 user_info->mapped.account_name));
	...
	if (!WBC_ERROR_IS_OK(wbc_status)) {
		DEBUG_OUT (10,("wbcAuthenticateUserEx failed (%d): %s\n",
	...
	DEBUG_OUT (10,("wbcAuthenticateUserEx succeeded\n"));
