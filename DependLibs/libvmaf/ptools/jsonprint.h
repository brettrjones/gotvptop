...
// Forwards
inline std::ostream& JSONListPrintHelper_ (Arr& a, std::ostream& os, int indent,
				      bool pretty, int indent_additive);
inline std::ostream& JSONPrimitivePrintHelper_ (const Val& v, std::ostream& os);


inline std::ostream& JSONTablePrintHelper_ (const Val& t, std::ostream& os, int indent, 
				       bool pretty, int indent_additive) 
{
...
template <class POD> 
std::ostream& JSONPODListPrintHelper_ (const POD* a, int len, std::ostream& os, 
...
inline std::ostream& JSONListPrintDispatcher_ (const Val& v, std::ostream& os, 
					  int indent, bool pretty, 
					  int indent_additive) 
{
  if (v.tag=='u') {
...
std::ostream& JSONPrimitivePrintHelper_ (const Val& v, std::ostream& os)
{
  switch (v.tag) {
...
inline std::ostream& JSONPrint (const Val& v, std::ostream& os, 
