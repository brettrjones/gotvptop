...
#include "libvmaf/ptools/opencontainers_1_8_4/include/ocport.h"
#include <stdio.h>
#include <ctype.h>

// Distinguish between M2k and OpenContainers usage
//#if defined(OC_USE_OC) || defined(OC_NEW_STYLE_INCLUDES)
#include "libvmaf/ptools/opencontainers_1_8_4/include/ocarray.h"
...
void PrintBufferToString (const char* vbuff, int bytes, OC::Array<char>& a);
