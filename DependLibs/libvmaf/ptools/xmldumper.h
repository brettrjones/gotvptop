...
class XMLDumper {
 public:
  ...
  XMLDumper (std::ostream& os, int options=0, ArrayDisposition_e arr_dis=AS_LIST, 
 ...
 protected:
  ...
  std::ostream* os_;             // Stream outputting to
...
inline void WriteValToXMLStream (const Val& v, std::ostream& ofs,
...
{
  std::ostringstream stream_thing;
