...
#include "libvmaf/ptools/opencontainers_1_8_4/include/ocstringtools.h"
#include <ctype.h>
...
inline std::ostream& prettyPrintOpalHelper_ (const Tab& t, 
					std::ostream& os, int indent, bool pretty,
					int indent_additive, bool as_m2k_array);
inline std::ostream& prettyPrintOpalHelper_ (const Arr& t, 
					std::ostream& os, int indent, bool pretty,
					int indent_additive, bool as_m2k_array);
inline std::ostream& prettyPrintVector_ (const Val& v, std::ostream& os);


 
// Steal image and unimage from m2k 
inline string M2Image (const std::string& s)
{
  // The final result
  std::string result = "";
  std::string ender = "";
...
inline std::string M2Unimage (const std::string& s)
{
  // The final result
  string result;
...
inline void simplePrettyPrintOpal_ (const Val& value, std::ostream& os,
				    bool with_tags = true)
{
...
inline std::ostream& prettyPrintOpalHelper_ (const Arr& a, 
					std::ostream& os, int indent, bool pretty,
					int indent_additive, bool as_m2k_array)
{
...
inline void prettyPrintOpal (const Arr& a, std::ostream& os, 
			     int indent = 0, int starting_indent=4, 
			     bool as_m2k_array=false) 
{
  indentOut_(os, indent);
  prettyPrintOpalHelper_(a, os, indent, true, starting_indent, as_m2k_array) << std::endl;
}
  

template <class T>
inline void prettyPrintVectorHelper_ (char tag, Array<T>& a, std::ostream& os)
{
...
inline void prettyPrintOpal (const Tab& t, std::ostream& os, 
			     int indent=0, int indent_additive=4, 
			     bool pretty=true, bool as_m2k_array=false)
{
  indentOut_(os, indent);
  prettyPrintOpalHelper_(t, os, indent, pretty, indent_additive, as_m2k_array) << std::endl;
}


inline void prettyPrintOpal (const Val& v, std::ostream& os, 
