...
//			return FeatureEnabled[feature] && COGLES1ExtensionHandler::queryFeature(feature);
	...
	private:
		...
		GOTV_INLINE void createGLMatrix(GLfloat gl_matrix[16], const core::matrix4& m);

		GOTV_INLINE void createGLTextureMatrix(GLfloat gl_matrix[16], const core::matrix4& m);
