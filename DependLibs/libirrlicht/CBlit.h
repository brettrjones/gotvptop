...
GOTV_INLINE u32 GetClipCode( const AbsRectangle &r, const core::position2d<s32> &p )
{
...
/*
*/
GOTV_INLINE void GetClip(AbsRectangle &clipping, video::IImage * t)
{
	clipping.x0 = 0;
	clipping.y0 = 0;
...
*/
static GOTV_INLINE u32 extractAlpha(const u32 c)
{
	return ( c >> 24 ) + ( c >> 31 );
}
...
/*
	...
	add highbit alpha ( alpha > 127 ? + 1 )
*/
static GOTV_INLINE u32 packAlpha(const u32 c)
{
...
/*!
	...
	value 0 - 256 ( alpha )
*/
GOTV_INLINE u32 PixelLerp32(const u32 source, const u32 value)
{
...
static GOTV_INLINE tExecuteBlit getBlitter2( eBlitter operation,const video::IImage * dest,const video::IImage * source )
{
...
GOTV_INLINE void setClip ( AbsRectangle &out, const core::rect<s32> *clip,
