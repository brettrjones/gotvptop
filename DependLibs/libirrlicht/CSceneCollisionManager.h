...
namespace scene
{
	...
	public:
		...
		virtual bool getCollisionPoint(const core::line3d<f32>& ray,
			...
			ISceneNode* & outNode,
			s32 * ps32RetTriangleIndex = 0); // BRJ 2010-06-02 added to return index of triangle so can get uv coords etc
	...
	private:
		...
		GOTV_INLINE bool getLowestRoot(f32 a, f32 b, f32 c, f32 maxR, f32* root);
