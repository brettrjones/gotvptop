...
namespace video
{
	...
	GOTV_INLINE void scolorfToRGBAfloat4(const SColorf& inColor, float* outColor)
	{
	...
	GOTV_INLINE void vector3dfToFloat4(const core::vector3df& inVector, float* outVector, float inW)
	{
	...
	GOTV_INLINE void vector3dfToFloat3(const core::vector3df& inVector, float* outVector)
	{
		outVector[0] = inVector.X;
		outVector[1] = inVector.Y;
		outVector[2] = inVector.Z;
	...
	GOTV_INLINE void scolortoFloat4(const SColor &irrColor, float *glColor)
	{
	...
	GOTV_INLINE bool operator!=(const SColorf& a, const SColorf& b)
	{
		return ((a.r != b.r) ||
			(a.g != b.g) ||
			(a.b != b.b) ||
