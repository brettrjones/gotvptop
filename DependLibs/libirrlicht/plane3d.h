...
class plane3d
{
	public:
		...
		GOTV_INLINE bool operator==(const plane3d<T>& other) const { return (equals(D, other.D) && Normal==other.Normal);}

		GOTV_INLINE bool operator!=(const plane3d<T>& other) const { return !(*this == other);}
