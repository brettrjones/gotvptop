...
namespace video
{
	...
	GOTV_INLINE f32 pack_texureBlendFunc ( const E_BLEND_FACTOR srcFact, const E_BLEND_FACTOR dstFact, const E_MODULATE_FUNC modulate=EMFN_MODULATE_1X, const u32 alphaSource=EAS_TEXTURE )
	{
	...
	GOTV_INLINE void unpack_textureBlendFunc ( E_BLEND_FACTOR &srcFact, E_BLEND_FACTOR &dstFact,
	...
	GOTV_INLINE bool textureBlendFunc_hasAlpha ( const E_BLEND_FACTOR factor )
	{
		switch ( factor )
		{
			case EBF_SRC_ALPHA:
	...
	*/
	...
	public:
		...
		GOTV_INLINE bool operator!=(const SMaterial& b) const
		{
			bool different =
