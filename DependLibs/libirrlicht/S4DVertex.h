...
GOTV_INLINE void sCompressedVec4::setVec4 ( const sVec4 & v )
{
...
/*
	load a color value
*/
GOTV_INLINE void getTexel_plain2 (	tFixPoint &r, tFixPoint &g, tFixPoint &b,
							const sVec4 &v
							)
{
	r = tofix ( v.y );
...
/*
	load a color value
*/
GOTV_INLINE void getSample_color (	tFixPoint &a, tFixPoint &r, tFixPoint &g, tFixPoint &b,
							const sVec4 &v
							)
{
	a = tofix ( v.x );
...
/*
	load a color value
*/
GOTV_INLINE void getSample_color ( tFixPoint &r, tFixPoint &g, tFixPoint &b,const sVec4 &v )
{
	r = tofix ( v.y, COLOR_MAX * FIX_POINT_F32_MUL);
	g = tofix ( v.z, COLOR_MAX * FIX_POINT_F32_MUL);
	b = tofix ( v.w, COLOR_MAX * FIX_POINT_F32_MUL);
...
/*
	load a color value
*/
GOTV_INLINE void getSample_color (	tFixPoint &r, tFixPoint &g, tFixPoint &b,
