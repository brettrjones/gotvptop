...
namespace scene
{
	...
	*/
	struct SViewFrustum
	{
		...
		//! This constructor creates a view frustum based on a projection and/or view matrix.
		GOTV_INLINE void setFrom(const core::matrix4& mat);
		...
		GOTV_INLINE void recalculateBoundingBox();
	...
	*/
	GOTV_INLINE SViewFrustum::SViewFrustum(const SViewFrustum& other)
	{
	...
	GOTV_INLINE SViewFrustum::SViewFrustum(const core::matrix4& mat)
	{
		setFrom ( mat );
	}


	GOTV_INLINE void SViewFrustum::transform(const core::matrix4& mat)
	{
	...
	GOTV_INLINE core::vector3df SViewFrustum::getFarLeftUp() const
	{
		core::vector3df p;
	...
	GOTV_INLINE core::vector3df SViewFrustum::getFarLeftDown() const
	{
		core::vector3df p;
		planes[scene::SViewFrustum::VF_FAR_PLANE].getIntersectionWithPlanes(
	...
	GOTV_INLINE core::vector3df SViewFrustum::getFarRightUp() const
	{
		core::vector3df p;
		planes[scene::SViewFrustum::VF_FAR_PLANE].getIntersectionWithPlanes(
			planes[scene::SViewFrustum::VF_TOP_PLANE],
	...
	GOTV_INLINE core::vector3df SViewFrustum::getFarRightDown() const
	{
		core::vector3df p;
		planes[scene::SViewFrustum::VF_FAR_PLANE].getIntersectionWithPlanes(
			planes[scene::SViewFrustum::VF_BOTTOM_PLANE],
	...
	GOTV_INLINE core::vector3df SViewFrustum::getNearLeftUp() const
	{
		core::vector3df p;
	...
	GOTV_INLINE core::vector3df SViewFrustum::getNearLeftDown() const
	{
		core::vector3df p;
		planes[scene::SViewFrustum::VF_NEAR_PLANE].getIntersectionWithPlanes(
			planes[scene::SViewFrustum::VF_BOTTOM_PLANE],
	...
	GOTV_INLINE core::vector3df SViewFrustum::getNearRightUp() const
	{
		core::vector3df p;
		planes[scene::SViewFrustum::VF_NEAR_PLANE].getIntersectionWithPlanes(
			planes[scene::SViewFrustum::VF_TOP_PLANE],
	...
	GOTV_INLINE core::vector3df SViewFrustum::getNearRightDown() const
	{
		core::vector3df p;
		planes[scene::SViewFrustum::VF_NEAR_PLANE].getIntersectionWithPlanes(
			planes[scene::SViewFrustum::VF_BOTTOM_PLANE],
	...
	GOTV_INLINE const core::aabbox3d<f32> &SViewFrustum::getBoundingBox() const
	{
		return boundingBox;
	}

	GOTV_INLINE void SViewFrustum::recalculateBoundingBox()
	{
	...
	//! and/or view matrix.
	GOTV_INLINE void SViewFrustum::setFrom(const core::matrix4& mat)
	{
		// left clipping plane
	...
	*/
	GOTV_INLINE core::matrix4& SViewFrustum::getTransform(video::E_TRANSFORMATION_STATE state )
	{
		u32 index = 0;
		switch ( state )
		{
	...
	/*!
		View Frustum depends on Projection & View Matrix
	*/
	GOTV_INLINE const core::matrix4& SViewFrustum::getTransform(video::E_TRANSFORMATION_STATE state ) const
	{
		u32 index = 0;
		switch ( state )
		{
	...
	GOTV_INLINE bool SViewFrustum::clipLine(core::line3d<f32>& line) const
	{
