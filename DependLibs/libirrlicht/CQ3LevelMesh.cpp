...
/*!
*/
GOTV_INLINE bool isQ3WhiteSpace( const u8 symbol )
{
...
/*!
*/
GOTV_INLINE bool isQ3ValidName( const u8 symbol )
{
...
GOTV_INLINE void CQ3LevelMesh::copy( video::S3DVertex2TCoords * dest, const tBSPVertex * source, s32 vertexcolor ) const
{
#if defined (TJUNCTION_SOLVER_ROUND)
	dest->Pos.X = core::round_( source->vPosition[0] );
	dest->Pos.Y = core::round_( source->vPosition[2] );
