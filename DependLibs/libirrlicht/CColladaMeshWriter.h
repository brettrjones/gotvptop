...
protected:
	...
	GOTV_INLINE irr::core::stringw toString(const irr::core::vector3df& vec) const;
	GOTV_INLINE irr::core::stringw uvToString(const irr::core::vector2df& vec) const;
	GOTV_INLINE irr::core::stringw toString(const irr::core::vector2df& vec) const;
	GOTV_INLINE irr::core::stringw toString(const irr::video::SColorf& colorf, bool writeAlpha=true) const;
	GOTV_INLINE irr::core::stringw toString(const irr::video::ECOLOR_FORMAT format) const;
	GOTV_INLINE irr::core::stringw toString(const irr::video::E_TEXTURE_CLAMP clamp) const;
	GOTV_INLINE irr::core::stringw toString(const irr::scene::E_COLLADA_TRANSPARENT_FX opaque) const;
	GOTV_INLINE irr::core::stringw toRef(const irr::core::stringw& source) const;
	...
	GOTV_INLINE bool isXmlNameStartChar(wchar_t c) const;
	GOTV_INLINE bool isXmlNameChar(wchar_t c) const;
