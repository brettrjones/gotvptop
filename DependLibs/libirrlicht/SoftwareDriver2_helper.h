...
GOTV_INLINE void memset32 ( void * dest, const u32 value, u32 bytesize )
{
	u32 * d = (u32*) dest;
...
static GOTV_INLINE s32 s32_log2_f32( f32 f)
{
	u32 x = IR ( f );
	return ((x & 0x7F800000) >> 23) - 127;
}

static GOTV_INLINE s32 s32_log2_s32(u32 x)
{
	return s32_log2_f32( (f32) x);
}

static GOTV_INLINE s32 s32_abs(s32 x)
{
	s32 b = x >> 31;
	return (x ^ b ) - b;
}
...
/*!
	...
	alpha [0;32]
*/
GOTV_INLINE u16 PixelBlend16 ( const u16 c2, const u32 c1, const u16 alpha )
{
...
*/
GOTV_INLINE u16 PixelMul16 ( const u16 c0, const u16 c1)
{
...
/*
	Pixel = c0 * (c1/31).
*/
GOTV_INLINE u16 PixelMul16_2 ( u16 c0, u16 c1)
{
	return	(u16)(( ( (c0 & 0x7C00) * (c1 & 0x7C00) ) & 0x3E000000 ) >> 15 |
			( ( (c0 & 0x03E0) * (c1 & 0x03E0) ) & 0x000F8000 ) >> 10 |
			( ( (c0 & 0x001F) * (c1 & 0x001F) ) & 0x000003E0 ) >> 5  |
...
GOTV_INLINE u16 PixelBlend16 ( const u16 destination, const u16 source )
{
...
GOTV_INLINE u32 PixelBlend16_simd ( const u32 destination, const u32 source )
{
...
// 1 - Bit Alpha Blending
GOTV_INLINE u16 PixelBlend16 ( const u16 c2, const u16 c1 )
{
...
// 1 - Bit Alpha Blending 16Bit SIMD
GOTV_INLINE u32 PixelBlend16_simd ( const u32 c2, const u32 c1 )
{
...
*/
GOTV_INLINE u32 PixelBlend32 ( const u32 c2, const u32 c1 )
{
	// alpha test
...
*/
GOTV_INLINE tFixPoint s32_to_fixPoint (const s32 x)
{
	return x << FIX_POINT_PRE;
}

GOTV_INLINE tFixPointu u32_to_fixPoint (const u32 x)
{
	return x << FIX_POINT_PRE;
}

GOTV_INLINE u32 fixPointu_to_u32 (const tFixPointu x)
{
	return x >> FIX_POINT_PRE;
}
...
*/
static GOTV_INLINE int f_round2(f32 f)
{
	f += (3<<22);
...
GOTV_INLINE s32 roundFix ( const tFixPoint x )
{
...
// x in [0;1[
GOTV_INLINE s32 f32_to_23Bits(const f32 x)
{
    f32 y = x + 1.f;
...
*/
GOTV_INLINE void color_to_fix ( tFixPoint &r, tFixPoint &g, tFixPoint &b, const tVideoSample t00 )
{
...
/*!
	return fixpoint from VideoSample granularity COLOR_MAX
*/
GOTV_INLINE void color_to_fix ( tFixPoint &a, tFixPoint &r, tFixPoint &g, tFixPoint &b, const tVideoSample t00 )
{
...
*/
GOTV_INLINE void color_to_fix1 ( tFixPoint &r, tFixPoint &g, tFixPoint &b, const tVideoSample t00 )
{
...
/*!
	return fixpoint from VideoSample granularity 0..FIX_POINT_ONE
*/
GOTV_INLINE void color_to_fix1 ( tFixPoint &a, tFixPoint &r, tFixPoint &g, tFixPoint &b, const tVideoSample t00 )
{
...
GOTV_INLINE tVideoSample getTexel_plain ( const sInternalTexture * t, const tFixPointu tx, const tFixPointu ty )
{
	u32 ofs;
...
GOTV_INLINE void getTexel_fix ( tFixPoint &r, tFixPoint &g, tFixPoint &b,
...
GOTV_INLINE void getSample_texture_dither (	tFixPoint &r, tFixPoint &g, tFixPoint &b,
										const sInternalTexture * t, const tFixPointu tx, const tFixPointu ty,
...
GOTV_INLINE void getSample_texture ( tFixPoint &r, tFixPoint &g, tFixPoint &b,
						const sInternalTexture * t, const tFixPointu tx, const tFixPointu ty
								)
{
	u32 ofs;
...
GOTV_INLINE void getSample_texture ( tFixPointu &a, tFixPointu &r, tFixPointu &g, tFixPointu &b,
						const sInternalTexture * t, const tFixPointu tx, const tFixPointu ty
								)
{
	u32 ofs;
...
GOTV_INLINE bool intersect ( AbsRectangle &dest, const AbsRectangle& a, const AbsRectangle& b)
{
...
GOTV_INLINE s32 intervall_intersect_test( const sIntervall& a, const sIntervall& b)
{
