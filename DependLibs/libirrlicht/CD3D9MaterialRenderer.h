...
GOTV_INLINE void setTextureColorStage(IDirect3DDevice9* dev, DWORD i,
...
GOTV_INLINE void setTextureColorStage(IDirect3DDevice9* dev, DWORD i, DWORD arg1)
{
	dev->SetTextureStageState(i, D3DTSS_COLOROP, D3DTOP_SELECTARG1);
	dev->SetTextureStageState(i, D3DTSS_COLORARG1, arg1);
}

GOTV_INLINE void setTextureAlphaStage(IDirect3DDevice9* dev, DWORD i,
		DWORD arg1, DWORD op, DWORD arg2)
{
...
GOTV_INLINE void setTextureAlphaStage(IDirect3DDevice9* dev, DWORD i, DWORD arg1)
{
