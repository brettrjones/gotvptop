...
# include "config_kvazaar.h" // IWYU pragma: export
...
#define MSC_X86_SIMD(level) (defined(_M_X64) || (_M_IX86_FP >= (level)))
...
#if defined (_M_ARM) || defined(__arm__) || defined(__thumb__) || defined(TARGET_CPU_ARM)
