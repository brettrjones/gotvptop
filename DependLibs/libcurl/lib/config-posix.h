#ifndef HEADER_CURL_CONFIG_POSIX_H
#define HEADER_CURL_CONFIG_POSIX_H
/***************************************************************************
 *                                  _   _ ____  _
 *  Project                     ___| | | |  _ \| |
 *                             / __| | | | |_) | |
...
#if !defined(TARGET_OS_LINUX) && !defined(_SSIZE_T_DEFINED) && !defined(__ssize_t)
...
#    define _SSIZE_T_DEFINED
#    define ssize_t int
#   endif // !defined(_SSIZE_T_DEFINED)
#  endif
#endif
...
#endif /* HEADER_CURL_CONFIG_POSIX_H */
