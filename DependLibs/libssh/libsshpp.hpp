 ...
 * - Most of the functions in this file are really short and are probably worth the "GOTV_INLINE"
...
public:
   ...
   */
  GOTV_INLINE Channel *acceptForward(int timeout_ms);
...
GOTV_INLINE Channel *Session::acceptForward(int timeout_ms){
    ssh_channel forward =
