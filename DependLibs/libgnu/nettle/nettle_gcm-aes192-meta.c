...
{
  nettle_gcm_aes192_set_iv (ctx, GCM_IV_SIZE, nonce);
}
...
const struct nettle_aead nettle_gcm_aes192 =
  { "gcm_aes192", sizeof(struct gcm_aes192_ctx),
    ...
    (nettle_set_key_func *) nettle_gcm_aes192_set_key,
    (nettle_set_key_func *) nettle_gcm_aes192_set_key,
    gcm_aes192_set_nonce_wrapper,
    (nettle_hash_update_func *) nettle_gcm_aes192_update,
    (nettle_crypt_func *) nettle_gcm_aes192_encrypt,
    (nettle_crypt_func *) nettle_gcm_aes192_decrypt,
    (nettle_hash_digest_func *) nettle_gcm_aes192_digest,
  };
