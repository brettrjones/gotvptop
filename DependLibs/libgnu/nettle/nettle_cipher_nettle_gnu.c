...
#include <nettle/nettle_aes.h>
#include <nettle/nettle_camellia.h>
#include <nettle/nettle_arcfour.h>
#include <nettle/nettle_arctwo.h>
#include <libgnu/nettle/nettle_salsa20.h>
#include <nettle/nettle_des.h>
#include <nettle/nettle-meta.h>
#include <nettle/nettle_cbc.h>
#include <nettle/nettle_gcm.h>
#include <nettle/nettle_ccm.h>
#include <nettle/nettle_chacha-poly1305.h>
#include <fips.h>
...
static void
_nettle_gcm_encrypt(struct nettle_cipher_ctx *ctx, size_t length, uint8_t * dst,
                 const uint8_t * src)
{
	nettle_gcm_encrypt(GCM_CTX_GET_CTX(ctx->ctx_ptr), GCM_CTX_GET_KEY(ctx->ctx_ptr),
		    GCM_CTX_GET_CIPHER(ctx->ctx_ptr), ctx->cipher->encrypt_block,
		    length, dst, src);
}

static void
_nettle_gcm_decrypt(struct nettle_cipher_ctx *ctx, size_t length, uint8_t * dst,
                 const uint8_t * src)
{
	nettle_gcm_decrypt(GCM_CTX_GET_CTX(ctx->ctx_ptr), GCM_CTX_GET_KEY(ctx->ctx_ptr),
		    GCM_CTX_GET_CIPHER(ctx->ctx_ptr), ctx->cipher->encrypt_block,
		    length, dst, src);
}
...
static const struct nettle_cipher_st builtin_ciphers[] = {
	{  .algo = GNUTLS_CIPHER_AES_128_GCM,
	   ...
	   .encrypt_block = (nettle_cipher_func*)nettle_aes128_encrypt,
	   .decrypt_block = (nettle_cipher_func*)nettle_aes128_decrypt,

	   .ctx_size = sizeof(struct gcm_aes128_ctx),
	   .encrypt = _nettle_gcm_encrypt,
	   .decrypt = _nettle_gcm_decrypt,
	   .set_encrypt_key = (nettle_set_key_func*)nettle_gcm_aes128_set_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_gcm_aes128_set_key,

	   .tag = (nettle_hash_digest_func*)nettle_gcm_aes128_digest,
	   .auth = (nettle_hash_update_func*)nettle_gcm_aes128_update,
	   .set_iv = (setiv_func)nettle_gcm_aes128_set_iv,
	   .fips_allowed = 1
	},
	{  .algo = GNUTLS_CIPHER_AES_256_GCM,
	   .block_size = AES_BLOCK_SIZE,
	   .key_size = AES256_KEY_SIZE,
	   .encrypt_block = (nettle_cipher_func*)nettle_aes256_encrypt,
	   .decrypt_block = (nettle_cipher_func*)nettle_aes256_decrypt,

	   .ctx_size = sizeof(struct gcm_aes256_ctx),
	   .encrypt = _nettle_gcm_encrypt,
	   .decrypt = _nettle_gcm_decrypt,
	   .set_encrypt_key = (nettle_set_key_func*)nettle_gcm_aes256_set_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_gcm_aes256_set_key,
	   
	   .tag = (nettle_hash_digest_func*)nettle_gcm_aes256_digest,
	   .auth = (nettle_hash_update_func*)nettle_gcm_aes256_update,
	   .set_iv = (setiv_func)nettle_gcm_aes256_set_iv,
	   .fips_allowed = 1
	},
	{  .algo = GNUTLS_CIPHER_AES_128_CCM,
	   ...
	   .set_encrypt_key = (nettle_set_key_func*)nettle_aes128_set_encrypt_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_aes128_set_encrypt_key,
	...
	{  .algo = GNUTLS_CIPHER_AES_256_CCM,
	   ...
	   .aead_encrypt = _ccm_encrypt,
	   .aead_decrypt = _ccm_decrypt,
	   .set_encrypt_key = (nettle_set_key_func*)nettle_aes256_set_encrypt_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_aes256_set_encrypt_key,
	...
	{  .algo = GNUTLS_CIPHER_CAMELLIA_128_GCM,
	   ...
	   .encrypt = _nettle_gcm_encrypt,
	   .decrypt = _nettle_gcm_decrypt,
	   .set_encrypt_key = (nettle_set_key_func*)nettle_gcm_camellia128_set_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_gcm_camellia128_set_key,

	   .tag = (nettle_hash_digest_func*)nettle_gcm_camellia128_digest,
	   .auth = (nettle_hash_update_func*)nettle_gcm_camellia128_update,
	   .set_iv = (setiv_func)nettle_gcm_camellia128_set_iv
	},
	{  .algo = GNUTLS_CIPHER_CAMELLIA_256_GCM,
	   ...
	   .encrypt = _nettle_gcm_encrypt,
	   .decrypt = _nettle_gcm_decrypt,
	   .set_encrypt_key = (nettle_set_key_func*)nettle_gcm_camellia256_set_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_gcm_camellia256_set_key,
	   
	   .tag = (nettle_hash_digest_func*)nettle_gcm_camellia256_digest,
	   .auth = (nettle_hash_update_func*)nettle_gcm_camellia256_update,
	   .set_iv = (setiv_func)nettle_gcm_camellia256_set_iv
	},
	{  .algo = GNUTLS_CIPHER_AES_128_CBC,
	   ...
	   .set_encrypt_key = (nettle_set_key_func*)nettle_aes128_set_encrypt_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_aes128_set_decrypt_key,
	   .fips_allowed = 1
	},
	{  .algo = GNUTLS_CIPHER_AES_192_CBC,
	   .block_size = AES_BLOCK_SIZE,
	   .key_size = AES192_KEY_SIZE,
	   .encrypt_block = (nettle_cipher_func*)nettle_aes192_encrypt,
	   .decrypt_block = (nettle_cipher_func*)nettle_aes192_decrypt,

	   .ctx_size = sizeof(struct CBC_CTX(struct aes192_ctx, AES_BLOCK_SIZE)),
	   .encrypt = _cbc_encrypt,
	   .decrypt = _cbc_decrypt,
	   .set_encrypt_key = (nettle_set_key_func*)nettle_aes192_set_encrypt_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_aes192_set_decrypt_key,
	   .fips_allowed = 1
	},
	{  .algo = GNUTLS_CIPHER_AES_256_CBC,
	   ...
	   .decrypt = _cbc_decrypt,
	   .set_encrypt_key = (nettle_set_key_func*)nettle_aes256_set_encrypt_key,
	   .set_decrypt_key = (nettle_set_key_func*)nettle_aes256_set_decrypt_key,
	   .fips_allowed = 1
	},
