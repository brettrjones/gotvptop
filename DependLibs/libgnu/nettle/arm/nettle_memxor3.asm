...
define(<BTNC>, <r12>)
	...
	.file "nettle_memxor3.asm"

	.text
	.arm

	C nettle_memxor3(void *dst, const void *a, const void *b, size_t n)
	.align 2
...
.Lmemxor3_a_aligned:
	...
	C FIXME: consider software pipelining, similarly to the _nettle_memxor
	C loop.
