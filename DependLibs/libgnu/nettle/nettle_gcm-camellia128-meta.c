...
{
  nettle_gcm_camellia128_set_iv (ctx, GCM_IV_SIZE, nonce);
}
...
const struct nettle_aead nettle_gcm_camellia128 =
  { "gcm_camellia128", sizeof(struct gcm_camellia128_ctx),
    ...
    (nettle_set_key_func *) nettle_gcm_camellia128_set_key,
    (nettle_set_key_func *) nettle_gcm_camellia128_set_key,
    gcm_camellia128_set_nonce_wrapper,
    (nettle_hash_update_func *) nettle_gcm_camellia128_update,
    (nettle_crypt_func *) nettle_gcm_camellia128_encrypt,
    (nettle_crypt_func *) nettle_gcm_camellia128_decrypt,
    (nettle_hash_digest_func *) nettle_gcm_camellia128_digest,
  };
