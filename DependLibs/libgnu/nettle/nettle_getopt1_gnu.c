/* nettle_getopt_long and nettle_getopt_long_only entry points for GNU nettle_getopt.
...
/* Like nettle_getopt_long, but '-' as well as '--' can indicate a long option.
...
main (int argc, char **argv)
{
  ...
  while (1)
	...
	{0, 0, 0, 0}
      ...
      c = nettle_getopt_long (argc, argv, "abc:d:0123456789",
