...
{
  nettle_gcm_aes128_set_iv (ctx, GCM_IV_SIZE, nonce);
}
...
const struct nettle_aead nettle_gcm_aes128 =
  { "gcm_aes128", sizeof(struct gcm_aes128_ctx),
    ...
    (nettle_set_key_func *) nettle_gcm_aes128_set_key,
    (nettle_set_key_func *) nettle_gcm_aes128_set_key,
    gcm_aes128_set_nonce_wrapper,
    (nettle_hash_update_func *) nettle_gcm_aes128_update,
    (nettle_crypt_func *) nettle_gcm_aes128_encrypt,
    (nettle_crypt_func *) nettle_gcm_aes128_decrypt,
    (nettle_hash_digest_func *) nettle_gcm_aes128_digest,
  };
