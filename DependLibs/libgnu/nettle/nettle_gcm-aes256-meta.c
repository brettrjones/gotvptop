...
{
  nettle_gcm_aes256_set_iv (ctx, GCM_IV_SIZE, nonce);
}
...
const struct nettle_aead nettle_gcm_aes256 =
  { "gcm_aes256", sizeof(struct gcm_aes256_ctx),
    ...
    (nettle_set_key_func *) nettle_gcm_aes256_set_key,
    (nettle_set_key_func *) nettle_gcm_aes256_set_key,
    gcm_aes256_set_nonce_wrapper,
    (nettle_hash_update_func *) nettle_gcm_aes256_update,
    (nettle_crypt_func *) nettle_gcm_aes256_encrypt,
    (nettle_crypt_func *) nettle_gcm_aes256_decrypt,
    (nettle_hash_digest_func *) nettle_gcm_aes256_digest,
  };
