...
_nettle_sha1_compress(uint32_t *state, const uint8_t *input)
{
  ...
  subRound( A, B, C, D, E, f1, K1, data[ 0] ); DEBUG_OUT (0);
  subRound( E, A, B, C, D, f1, K1, data[ 1] ); DEBUG_OUT (1);
  ...
  subRound( A, B, C, D, E, f1, K1, data[15] ); DEBUG_OUT (15);
  subRound( E, A, B, C, D, f1, K1, expand( data, 16 ) ); DEBUG_OUT (16);
  subRound( D, E, A, B, C, f1, K1, expand( data, 17 ) ); DEBUG_OUT (17);
  subRound( C, D, E, A, B, f1, K1, expand( data, 18 ) ); DEBUG_OUT (18);
  subRound( B, C, D, E, A, f1, K1, expand( data, 19 ) ); DEBUG_OUT (19);

  subRound( A, B, C, D, E, f2, K2, expand( data, 20 ) ); DEBUG_OUT (20);
  subRound( E, A, B, C, D, f2, K2, expand( data, 21 ) ); DEBUG_OUT (21);
  ...
  subRound( C, D, E, A, B, f2, K2, expand( data, 38 ) ); DEBUG_OUT (38);
  subRound( B, C, D, E, A, f2, K2, expand( data, 39 ) ); DEBUG_OUT (39);

  subRound( A, B, C, D, E, f3, K3, expand( data, 40 ) ); DEBUG_OUT (40);
  subRound( E, A, B, C, D, f3, K3, expand( data, 41 ) ); DEBUG_OUT (41);
  ...
  subRound( C, D, E, A, B, f3, K3, expand( data, 58 ) ); DEBUG_OUT (58);
  subRound( B, C, D, E, A, f3, K3, expand( data, 59 ) ); DEBUG_OUT (59);

  subRound( A, B, C, D, E, f4, K4, expand( data, 60 ) ); DEBUG_OUT (60);
  subRound( E, A, B, C, D, f4, K4, expand( data, 61 ) ); DEBUG_OUT (61);
  ...
  subRound( C, D, E, A, B, f4, K4, expand( data, 78 ) ); DEBUG_OUT (78);
  subRound( B, C, D, E, A, f4, K4, expand( data, 79 ) ); DEBUG_OUT (79);
