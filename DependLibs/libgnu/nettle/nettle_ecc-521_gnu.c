...
#include "nettle_ecc.h"
#include "nettle_ecc-internal.h"

#define USE_REDC 0

#include "nettle_ecc-521.h"

#if HAVE_NATIVE_ecc_521_modp
#define ecc_521_modp nettle_ecc_521_modp
void
nettle_ecc_521_modp(const struct ecc_modulo *m, mp_limb_t *rp);
...
static void
nettle_ecc_521_modp (const struct ecc_modulo *m UNUSED, mp_limb_t *rp)
{
