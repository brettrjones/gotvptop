...
#define NETTLE_BLK16_CHAR_CNT 16

#if (SIZEOF_UNSIGNED_LONG_INT == 8) 
# define NETTLE_BLK16_LONG_CNT 2 
#else
# define NETTLE_BLK16_LONG_CNT 4
#endif // NETTLE_BLK16_LONG_CNT
...
{
  uint8_t b[ NETTLE_BLK16_CHAR_CNT ];
  unsigned long w[ NETTLE_BLK16_LONG_CNT ];
};
