...
#define nettle_gcm_aes_set_key nettle_gcm_aes_set_key
#define nettle_gcm_aes_set_iv nettle_gcm_aes_set_iv
#define nettle_gcm_aes_update nettle_gcm_aes_update
#define nettle_gcm_aes_encrypt nettle_gcm_aes_encrypt
#define nettle_gcm_aes_decrypt nettle_gcm_aes_decrypt
#define nettle_gcm_aes_digest nettle_gcm_aes_digest

#define nettle_gcm_camellia128_set_key nettle_gcm_camellia128_set_key
#define nettle_gcm_camellia128_set_iv nettle_gcm_camellia128_set_iv
#define nettle_gcm_camellia128_update nettle_gcm_camellia128_update
#define nettle_gcm_camellia128_encrypt nettle_gcm_camellia128_encrypt
#define nettle_gcm_camellia128_decrypt nettle_gcm_camellia128_decrypt
#define nettle_gcm_camellia128_digest nettle_gcm_camellia128_digest

#define nettle_gcm_camellia256_set_key nettle_gcm_camellia256_set_key
#define nettle_gcm_camellia256_set_iv nettle_gcm_camellia256_set_iv
#define nettle_gcm_camellia256_update nettle_gcm_camellia256_update
#define nettle_gcm_camellia256_encrypt nettle_gcm_camellia256_encrypt
#define nettle_gcm_camellia256_decrypt nettle_gcm_camellia256_decrypt
#define nettle_gcm_camellia256_digest nettle_gcm_camellia256_digest
*/
...
#define GCM_SET_KEY(ctx, set_key, encrypt, gcm_key)		\
  do {								\
    ...
    nettle_gcm_set_key(&(ctx)->key, &(ctx)->cipher,			\
		(nettle_cipher_func *) (encrypt));		\
  } while (0)

#define GCM_SET_IV(ctx, length, data)				\
  nettle_gcm_set_iv(&(ctx)->gcm, &(ctx)->key, (length), (data))
...
#define GCM_ENCRYPT(ctx, encrypt, length, dst, src)			\
  (0 ? (encrypt)(&(ctx)->cipher, ~(size_t) 0,				\
		 (uint8_t *) 0, (const uint8_t *) 0)			\
     : nettle_gcm_encrypt(&(ctx)->gcm, &(ctx)->key, &(ctx)->cipher,		\
		   (nettle_cipher_func *) (encrypt),			\
		   (length), (dst), (src)))
...
#define GCM_DECRYPT(ctx, encrypt, length, dst, src)			\
  (0 ? (encrypt)(&(ctx)->cipher, ~(size_t) 0,				\
		 (uint8_t *) 0, (const uint8_t *) 0)			\
     : nettle_gcm_decrypt(&(ctx)->gcm,  &(ctx)->key, &(ctx)->cipher,		\
		   (nettle_cipher_func *) (encrypt),			\
		   (length), (dst), (src)))
...
#define GCM_DIGEST(ctx, encrypt, length, digest)			\
  (0 ? (encrypt)(&(ctx)->cipher, ~(size_t) 0,				\
		 (uint8_t *) 0, (const uint8_t *) 0)			\
     : nettle_gcm_digest(&(ctx)->gcm, &(ctx)->key, &(ctx)->cipher,		\
		  (nettle_cipher_func *) (encrypt),			\
		  (length), (digest)))
...
void
nettle_gcm_aes_set_key(struct gcm_aes_ctx *ctx,
...
void
nettle_gcm_aes_update(struct gcm_aes_ctx *ctx,
	       size_t length, const uint8_t *data);
...
void
nettle_gcm_aes_digest(struct gcm_aes_ctx *ctx, size_t length, uint8_t *digest);


struct gcm_camellia128_ctx GCM_CTX(struct camellia128_ctx);

void nettle_gcm_camellia128_set_key(struct gcm_camellia128_ctx *ctx,
			     const uint8_t *key);
void nettle_gcm_camellia128_set_iv(struct gcm_camellia128_ctx *ctx,
			    size_t length, const uint8_t *iv);
void nettle_gcm_camellia128_update(struct gcm_camellia128_ctx *ctx,
			    size_t length, const uint8_t *data);
void nettle_gcm_camellia128_encrypt(struct gcm_camellia128_ctx *ctx,
			     size_t length, uint8_t *dst, const uint8_t *src);
void nettle_gcm_camellia128_decrypt(struct gcm_camellia128_ctx *ctx,
			     size_t length, uint8_t *dst, const uint8_t *src);
void nettle_gcm_camellia128_digest(struct gcm_camellia128_ctx *ctx,
			    size_t length, uint8_t *digest);


struct gcm_camellia256_ctx GCM_CTX(struct camellia256_ctx);

void nettle_gcm_camellia256_set_key(struct gcm_camellia256_ctx *ctx,
			     const uint8_t *key);
void nettle_gcm_camellia256_set_iv(struct gcm_camellia256_ctx *ctx,
			    size_t length, const uint8_t *iv);
void nettle_gcm_camellia256_update(struct gcm_camellia256_ctx *ctx,
			    size_t length, const uint8_t *data);
void nettle_gcm_camellia256_encrypt(struct gcm_camellia256_ctx *ctx,
			     size_t length, uint8_t *dst, const uint8_t *src);
void nettle_gcm_camellia256_decrypt(struct gcm_camellia256_ctx *ctx,
			     size_t length, uint8_t *dst, const uint8_t *src);
void nettle_gcm_camellia256_digest(struct gcm_camellia256_ctx *ctx,
			    size_t length, uint8_t *digest);
