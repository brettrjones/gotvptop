...
_nettle_md5_compress(uint32_t *digest, const uint8_t *input)
{
  ...
  DEBUG_OUT (-1);
  ROUND(F1, a, b, c, d, data[ 0] + 0xd76aa478, 7); DEBUG_OUT (0);
  ROUND(F1, d, a, b, c, data[ 1] + 0xe8c7b756, 12); DEBUG_OUT (1);
  ...
  ROUND(F1, b, c, d, a, data[15] + 0x49b40821, 22); DEBUG_OUT (15);

  ROUND(F2, a, b, c, d, data[ 1] + 0xf61e2562, 5); DEBUG_OUT (16);
  ROUND(F2, d, a, b, c, data[ 6] + 0xc040b340, 9); DEBUG_OUT (17);
  ...
  ROUND(F2, b, c, d, a, data[12] + 0x8d2a4c8a, 20); DEBUG_OUT (31);

  ROUND(F3, a, b, c, d, data[ 5] + 0xfffa3942, 4); DEBUG_OUT (32);
  ROUND(F3, d, a, b, c, data[ 8] + 0x8771f681, 11); DEBUG_OUT (33);
  ...
  ROUND(F3, b, c, d, a, data[ 2] + 0xc4ac5665, 23); DEBUG_OUT (47);

  ROUND(F4, a, b, c, d, data[ 0] + 0xf4292244, 6); DEBUG_OUT (48);
  ROUND(F4, d, a, b, c, data[ 7] + 0x432aff97, 10); DEBUG_OUT (49);
  ...
  ROUND(F4, b, c, d, a, data[ 9] + 0xeb86d391, 21); DEBUG_OUT (63);
