...
/* Name mangling */
//#define aes_set_key _nettle_aes_set_key
//#define aes_invert _nettle_aes_invert
//#define aes_encrypt _nettle_aes_encrypt
//#define aes_encrypt _nettle_aes_decrypt
//#define aes_encrypt_table _nettle_aes_encrypt_table
...
void _nettle_aes_set_key(unsigned nr, unsigned nk,
...
void _nettle_aes_decrypt( unsigned rounds, const uint32_t *keys,
						  const struct aes_table *T,
						  size_t length, uint8_t *dst,
						  const uint8_t *src );

void _nettle_salsa20_core( uint32_t *dst, const uint32_t *src, unsigned rounds );
...
void _nettle_sha512_compress( uint64_t *state, const uint8_t *input, const uint64_t *k );

void nettle_sha3_permute( struct sha3_state *state );

uint64_t _nettle_umac_nh( const uint32_t *key, unsigned length, const uint8_t *msg );

void _nettle_umac_nh_n( uint64_t *out, unsigned n, const uint32_t *key,
...
/* Globally visible so that the same sbox table can be used by nettle_aes_set_encrypt_key */
