...
main (int argc, char **argv)
{
  ...
  while ( (c = nettle_getopt_long(argc, argv, "Vl:i:", options, NULL)) != -1)
    switch (c)
      {
      default:
	abort();
  ...
  pbkdf2_nettle_hmac_sha256 (password_length, password, iterations, salt_length, salt,
