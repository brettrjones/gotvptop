 ...
 */
void camellia_encrypt128(const uint32_t *subkey, uint32_t *blocks)
{
...
void camellia_decrypt128(const uint32_t *subkey, uint32_t *blocks)
{
 ...
 */
void camellia_encrypt256(const uint32_t *subkey, uint32_t *blocks)
{
    uint32_t il,ir,t0,t1;           /* temporary valiables */
    uint32_t io[4];
...
void camellia_decrypt256(const uint32_t *subkey, uint32_t *blocks)
{
    uint32_t il,ir,t0,t1;           /* temporary valiables */
    uint32_t io[4];
