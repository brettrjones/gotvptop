...
extern void _gcry_blowfish_amd64_do_encrypt(BLOWFISH_context *c, uint32_t *ret_xl,
					    uint32_t *ret_xr);
...
static void
do_encrypt ( BLOWFISH_context *bc, uint32_t *ret_xl, uint32_t *ret_xr )
{
...
/* Assembly implementations of Blowfish. */
extern void _gcry_blowfish_arm_do_encrypt(BLOWFISH_context *c, uint32_t *ret_xl,
					    uint32_t *ret_xr);
...
static void
decrypt ( BLOWFISH_context *bc, uint32_t *ret_xl, uint32_t *ret_xr )
{
#if BLOWFISH_ROUNDS == 16
  uint32_t xl, xr, *s0, *s1, *s2, *s3, *p;
