...
typedef unsigned int (*salsa20_core_t) (uint32_t *dst, struct SALSA20_context_s *ctx,
                                        unsigned int rounds);
...
typedef struct SALSA20_context_s
{
  ...
  */
  ...
  uint32_t pad[SALSA20_INPUT_LENGTH];
...
void _gcry_salsa20_amd64_keysetup(uint32_t *ctxinput, const void *key, int keybits);
void _gcry_salsa20_amd64_ivsetup(uint32_t *ctxinput, const void *iv);
unsigned int
_gcry_salsa20_amd64_encrypt_blocks(uint32_t *ctxinput, const void *src, void *dst,
...
static unsigned int
salsa20_core (uint32_t *dst, SALSA20_context_t *ctx, unsigned int rounds)
{
...
static unsigned int
salsa20_core (uint32_t *dst, SALSA20_context_t *ctx, unsigned rounds)
{
  uint32_t pad[SALSA20_INPUT_LENGTH], *src = ctx->input;
  unsigned int i;
...
static unsigned int
salsa20_core_neon (uint32_t *dst, SALSA20_context_t *ctx, unsigned int rounds)
{
