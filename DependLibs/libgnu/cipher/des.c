...
static void des_key_schedule (const byte *, uint32_t *);
 ...
 */
static void
des_key_schedule (const byte * rawkey, uint32_t * subkey)
{
...
{
  /*
   * Check if 'uint32_t' is really 32 bits wide. This DES / 3DES implementation
   * need this.
   */
