...
/* Special invocation convention:
   - On Mac OS X 10.3.9 we have a sequence of nested includes
     <unistd.h> -> <signal_gnu.h> -> <libpthread/pthread.h> -> <unistd.h>
...
$USERNAME               on native Windows platforms.
*/
char * getlogin( void ); // implemented in misc/cvuser.
struct passwd * getpwnam( const char *name ); // implemented in djpp/getpwnam.c
