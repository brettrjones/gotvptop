...
//# define gl_locale_name_canonicalize gl_locale_name_canonicalize
extern void gl_locale_name_canonicalize (char *name);
//# define gl_locale_name_from_win32_LANGID gl_locale_name_from_win32_LANGID
extern const char *gl_locale_name_from_win32_LANGID (LANGID langid); 
//# define gl_locale_name_from_win32_LCID gl_locale_name_from_win32_LCID
...
extern const char *gl_locale_name_posix(int category,
					  const char *categoryname);
//# define gl_locale_name_environ _nl_locale_name_environ
extern const char *gl_locale_name_environ(int category,
					    const char *categoryname);
