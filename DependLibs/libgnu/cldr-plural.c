...
#    include <alloca_gnu.h> /* INFRINGES ON USER NAME SPACE */
#   elif defined _AIX
...
static const char *const yytname[] =
{
  ...
  "OTHER", "AT_INTEGER", "AT_DECIMAL", "KEYWORD", "INTEGER", "DECIMAL_GNU",
  "OPERAND", "';'", "':'", "'='", "'!'", "'%'", "','", "'~'", "$accept",
