...
#include <libgnu/nettle/nettle_memxor.h>
...
#include <libgnu/gnutls_hash_int.h>
#include <libgnu/gnutls_cipher_int.h>
#include <libgnu/gnutls_compress.h>
