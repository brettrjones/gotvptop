...
#if defined TARGET_OS_WINDOWS || defined __CYGWIN__ /* Native Windows or Cygwin */
...
//static
//# endif
void gl_locale_name_canonicalize( char *name )
{
...
#if !(HAVE_CFLOCALECOPYCURRENT || HAVE_CFPREFERENCESCOPYAPPVALUE || defined TARGET_OS_WINDOWS || defined __CYGWIN__)
