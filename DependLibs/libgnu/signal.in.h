...
/* Special invocation convention:
   ...
   - On glibc systems we have a sequence of nested includes
     <signal_gnu.h> -> <ucontext.h> -> <signal_gnu.h>.
     In this situation, the functions are not yet declared, therefore we cannot
     provide the C++ aliases.
   - On glibc systems with GCC 4.3 we have a sequence of nested includes
     <csignal> -> </usr/include/signal.h> -> <sys/ucontext.h> -> <signal_gnu.h>.
...
/* Define pid_t, uid_t.
   Also, mingw defines sigset_t not in <signal_gnu.h>, but in <sys/types.h>.
   On Solaris 10, <signal_gnu.h> includes <sys/types.h>, which eventually includes
...
/* Mac OS X 10.3, FreeBSD 6.4, OpenBSD 3.8, OSF/1 4.0, Solaris 2.6, Android
   declare pthread_sigmask in <libpthread/pthread.h>, not in <signal_gnu.h>.
