...
#include "secmem_gnu.h" /* our own secmem allocator */
#include "ath.h"
...
# pragma GCC diagnostic ignored "-Wswitch"
    ...
    {
		LogMsg( LOG_DEBUG, "global_gnu: Init external random test is disabled" );
			/*
    ...
    case 59:  /* Run external random test.  */
      {
		LogMsg( LOG_DEBUG, "global_gnu: Run external random test is disabled" );
		/*
    ...
    case 60:  /* Deinit external random test.  */
      {
		LogMsg( LOG_DEBUG, "global_gnu: Deinit external random test is disabled" );
		/*
		void *ctx = va_arg( arg_ptr, void * );
