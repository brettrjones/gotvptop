...
enum gcry_log_levels
  {
    GCRY_LOG_CONT   = LOG_VERBOSE,    /* (Continue the last log line.) */
    GCRY_LOG_INFO   = LOG_INFO,
    GCRY_LOG_WARN   = LOG_WARN,
    GCRY_LOG_ERROR  = LOG_ERROR,
    GCRY_LOG_FATAL  = LOG_FATAL,
    GCRY_LOG_BUG    = LOG_STATUS,
    GCRY_LOG_DEBUG  = LOG_DEBUG
  };
