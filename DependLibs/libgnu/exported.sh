...
nm_cmd="//home/jack/arm-linux-androideabi-4.9-vanilla/android-21/bin/arm-linux-androideabi-nm $1 | sed -n -e 's/^.*[	 ]\([ABCDGIRSTW][ABCDGIRSTW]*\)[	 ][	 ]*\([_A-Za-z][_A-Za-z0-9]*\)$/\1 \2 \2/p' | sed '/ __gnu_lto/d'"
eval $nm_cmd
