...
#include <accelerated/x86/aes-x86.h>
#include <accelerated/x86/sha-x86.h>
...
static void
x86_hmac_sha1_set_key(struct nettle_hmac_sha1_ctx *ctx,
...
static void
x86_hmac_sha1_update(struct nettle_hmac_sha1_ctx *ctx,
...
static void
x86_hmac_sha1_digest(struct nettle_hmac_sha1_ctx *ctx,
...
static void
x86_hmac_sha256_set_key(struct nettle_hmac_sha256_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
x86_hmac_sha256_update(struct nettle_hmac_sha256_ctx *ctx,
			   size_t length, const uint8_t * data)
{
...
static void
x86_hmac_sha256_digest(struct nettle_hmac_sha256_ctx *ctx,
			   size_t length, uint8_t * digest)
{
...
static void
x86_hmac_sha224_set_key(struct nettle_hmac_sha224_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
x86_hmac_sha224_digest(struct nettle_hmac_sha224_ctx *ctx,
			   size_t length, uint8_t * digest)
{
...
#ifdef ENABLE_SHA512
static void
x86_hmac_sha384_set_key(struct nettle_hmac_sha384_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
x86_hmac_sha384_digest(struct nettle_hmac_sha384_ctx *ctx,
			   size_t length, uint8_t * digest)
{
...
static void
x86_hmac_sha512_set_key(struct nettle_hmac_sha512_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
x86_hmac_sha512_update(struct nettle_hmac_sha512_ctx *ctx,
			   size_t length, const uint8_t * data)
{
...
static void
x86_hmac_sha512_digest(struct nettle_hmac_sha512_ctx *ctx,
			   size_t length, uint8_t * digest)
{
