...
#include <nettle/nettle_macros.h>
#include <nettle/nettle_memxor.h>
#include <accelerated/x86/aes-padlock.h>
#include <accelerated/x86/sha-padlock.h>
...
static void
padlock_hmac_sha1_set_key(struct nettle_hmac_sha1_ctx *ctx,
...
static void
padlock_hmac_sha1_update(struct nettle_hmac_sha1_ctx *ctx,
...
static void
padlock_hmac_sha1_digest(struct nettle_hmac_sha1_ctx *ctx,
...
static void
padlock_hmac_sha256_set_key(struct nettle_hmac_sha256_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
padlock_hmac_sha256_update(struct nettle_hmac_sha256_ctx *ctx,
			   size_t length, const uint8_t * data)
{
...
static void
padlock_hmac_sha256_digest(struct nettle_hmac_sha256_ctx *ctx,
			   size_t length, uint8_t * digest)
{
...
static void
padlock_hmac_sha224_set_key(struct nettle_hmac_sha224_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
padlock_hmac_sha224_digest(struct nettle_hmac_sha224_ctx *ctx,
			   size_t length, uint8_t * digest)
{
...
static void
padlock_hmac_sha384_set_key(struct nettle_hmac_sha384_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
padlock_hmac_sha384_digest(struct nettle_hmac_sha384_ctx *ctx,
			   size_t length, uint8_t * digest)
{
...
static void
padlock_hmac_sha512_set_key(struct nettle_hmac_sha512_ctx *ctx,
			    size_t key_length, const uint8_t * key)
{
...
static void
padlock_hmac_sha512_update(struct nettle_hmac_sha512_ctx *ctx,
			   size_t length, const uint8_t * data)
{
...
static void
padlock_hmac_sha512_digest(struct nettle_hmac_sha512_ctx *ctx,
			   size_t length, uint8_t * digest)
{
		       ...
		       size_t text_size, void *digest)
{
	if (algo == GNUTLS_MAC_SHA1 || algo == GNUTLS_MAC_SHA256) {
		...
		nettle_memxor(pad, key, key_size);
		...
		nettle_memxor(pad2, key, key_size);
