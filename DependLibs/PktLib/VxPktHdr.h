...
{
public:
    VxGUID&						getSrcOnlineId( void )						{ return m_SrcOnlineId; }
	void						setSrcOnlineId( VxGUID& onlineId )			{ m_SrcOnlineId = onlineId; }	
	VxGUID&						getDestOnlineId( void )						{ return m_DestOnlineId; }
	void						setDestOnlineId( VxGUID& onlineId )			{ m_DestOnlineId = onlineId; }	
