#ifdef DefSFXName // don't include directly for compile.. will be included by other files
...
#endif
#if defined(TARGET_OS_WINDOWS) && !defined(_WIN_CE) && !defined(_XBOX) && !defined(_LINUX)
  if (CmtData.Size()>0)
...
#endif // DefSFXName // don't include directly for compile.. will be included by other files
