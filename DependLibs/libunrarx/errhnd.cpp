...
void ErrorHandler::CreateErrorMsg(const char *ArcName,const char *FileName)
{
  ...
  Alarm();
#if defined(TARGET_OS_WINDOWS) && !defined(_WIN_CE) && !defined(SFX_MODULE) && defined(MAXPATH)
...
#endif
{
#if defined(TARGET_OS_WINDOWS) && !defined(TARGET_POSIX)
...
{
#if defined(TARGET_OS_WINDOWS) && !defined(SFX_MODULE) && !defined(SILENT)
