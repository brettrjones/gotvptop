...
#include    <libopencore-amr/oscl/oscl_base.h>    /* Basic data types used within the lib */
#include    <libopencore-amr/include/pvamrwbdecoder_api.h>
#include      <libopencore-amr/include/pvgsmamrdecoderinterface.h>
