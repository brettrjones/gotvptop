...
void PFX_X265(dst4_ssse3)(const int16_t* src, int16_t* dst, intptr_t srcStride);
void PFX_X265(dst4_sse2)(const int16_t* src, int16_t* dst, intptr_t srcStride);
void PFX_X265(idst4_sse2)(const int16_t* src, int16_t* dst, intptr_t srcStride);
void PFX_X265(dst4_avx2)(const int16_t* src, int16_t* dst, intptr_t srcStride);
void PFX_X265(idst4_avx2)(const int16_t* src, int16_t* dst, intptr_t srcStride);
void PFX_X265(denoise_dct_sse4)(int16_t* dct, uint32_t* sum, const uint16_t* offset, int size);
void PFX_X265(denoise_dct_avx2)(int16_t* dct, uint32_t* sum, const uint16_t* offset, int size);
