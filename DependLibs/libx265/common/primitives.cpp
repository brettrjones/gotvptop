...
#else
extern "C" {
int PFX_X265(cpu_cpuid_test)(void) { return 0; }
void PFX_X265(cpu_emms)(void) {}
void PFX_X265(cpu_cpuid)(uint32_t, uint32_t *eax, uint32_t *, uint32_t *, uint32_t *) { *eax = 0; }
void PFX_X265(cpu_xgetbv)(uint32_t, uint32_t *, uint32_t *) {}

#if X265_ARCH_ARM == 0
void PFX_X265(cpu_neon_test)(void) {}
int PFX_X265(cpu_fast_neon_mrc_test)(void) { return 0; }
#endif // X265_ARCH_ARM
}
#endif
