...
const int PFX_X265(max_bit_depth) = 12;

#elif X265_DEPTH == 10

#define BITDEPTH "10bit"
const int PFX_X265(max_bit_depth) = 10;

#elif X265_DEPTH == 8

#define BITDEPTH "8bit"
const int PFX_X265(max_bit_depth) = 8;
...
const char* PFX_X265(version_str) = XSTR(X265_VERSION);
const char* PFX_X265(build_info_str) = ONOS COMPILEDBY BITS ASM ATOMICS CHECKED BITDEPTH ADD8 ADD10 ADD12;
