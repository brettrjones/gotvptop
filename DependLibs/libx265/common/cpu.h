...
#define PFX3_X265(prefix, name) prefix ## _ ## name
#define PFX2_X265(prefix, name) PFX3_X265(prefix, name)
#define PFX_X265(name)          PFX2_X265(X265_NS, name)

#include "common/common.h"


// from cpu-a.asm, if ASM primitives are compiled, else primitives.cpp
extern "C" void PFX_X265(cpu_emms)(void);
extern "C" void PFX_X265(safe_intel_cpu_indicator_init)(void);

#if _MSC_VER && _WIN64
#define x265_emms() PFX_X265(cpu_emms)()
#elif _MSC_VER
#include <mmintrin.h>
