...
//#define BUILD_PCRE_TABLES 1  // if defined then build console tool to create dftables
//#define BUILD_PCRE_GREP 1  // if defined then build console grep tool 


#endif // _PCRE_CONFIG_H_