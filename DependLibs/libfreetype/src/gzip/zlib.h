/* zlib.h -- freeTypeInterface of the 'zlib' general purpose compression library
...
/*
  ...
  with an freeTypeInterface similar to that of stdio.
...
/*
   ...
   basic stream-oriented functions. To simplify the freeTypeInterface, some
