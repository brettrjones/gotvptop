...
/*  cfftypes.h                                                             */
/*                                                                         */
/*    Basic OpenType/CFF type definitions and freeTypeInterface (specification     */
/*    only).                                                               */
/*                                                                         */
...
#define CFF_MAX_CID_FONTS  256
  ...
  typedef struct  CFF_FontRec_
  {
    ...
    /* freeTypeInterface to PostScript hinter */
    PSHinter_Service  pshinter;

    /* freeTypeInterface to Postscript Names service */
    FT_Service_PsCMaps  psnames;

    /* freeTypeInterface to CFFLoad service */
    const void*  cffload;
