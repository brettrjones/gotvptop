...
#define FT_DEFINE_CMAP_CLASS(                            \
  ...
  /*      If non-null, the freeTypeInterface through which glyph data and metrics  */
...
#define FT_DRIVER_HINTS_LIGHTLY( x )  ( FT_MODULE_CLASS( x )->module_flags & \
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Finds a module and returns its specific freeTypeInterface as a typeless    */
  /*    pointer.                                                           */
  /*                                                                       */
  /* <Input>                                                               */
  ...
  /*                                                                       */
  /* <Return>                                                              */
  /*    A module-specific freeTypeInterface if available, 0 otherwise.             */
  /*                                                                       */
  /* <Note>                                                                */
  /*    You should better be familiar with FreeType internals to know      */
  /*    which module to look for, and what its freeTypeInterface is :-)            */
  /*                                                                       */
  FT_BASE( const void* )
...
#define FT_DEBUG_HOOK_TRUETYPE  0
  ...
  /*                                                                       */
  /*    auto_hinter      :: The auto-hinter module freeTypeInterface.              */
  /*                                                                       */
  ...
  /* Define default raster's freeTypeInterface.  The default raster is located in  */
  /* `src/base/ftraster.c'.                                                */
  /*                                                                       */
...
#define FT_DEFINE_GLYPH(                              \
  ...
  /*    freeTypeInterface, and put them in the global pic container defined in     */
