...
#error "Example:"
#error "  #include <libfreetype/include/ft2build.h>"
...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /* <Abstract>                                                            */
  /*    The FreeType~2 base font freeTypeInterface.                                */
  /*                                                                       */
  /* <Description>                                                         */
  ...
  /*    it doesn't have an freeTypeInterface to quickly retrieve the glyph height. */
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*                           format specific freeTypeInterface to access them.   */
  ...
  /*                           specific freeTypeInterface to access them.          */
  /*                                                                       */
...
#define FT_FSTYPE_BITMAP_EMBEDDING_ONLY         0x0200
  ...
  /*                                                                       */
  /* <Abstract>                                                            */
  /*    The FreeType~2 freeTypeInterface to Unicode Variation Sequences (UVS),     */
