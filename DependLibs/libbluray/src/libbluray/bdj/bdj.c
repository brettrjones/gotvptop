...
#include "libbluray/src/file/dirs.h"
#include "libbluray/src/file/dl.h"
#include "libbluray/src/util/strutl.h"
...
#ifdef HAVE_BDJ_J2ME
#define BDJ_JARFILE "libbluray-j2me-" LIBBLURAY_VERSION ".jar"
#else
#define BDJ_JARFILE "libbluray-j2se-" LIBBLURAY_VERSION ".jar"
#endif
