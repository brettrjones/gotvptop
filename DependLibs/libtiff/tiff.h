...
#include "libtiff/config_libtiff.h"
 ...
 *
 * 8-bit quantities     int8_t/uint8_t
 * 16-bit quantities    int16_t/uint16_t
 * 32-bit quantities    int32_t/uint32_t
 * 64-bit quantities    int64_t/uint64_t
