...
#ifdef USE_DL_EXPORT
echo Deprecated USE_DL_EXPORT macro - please use Py_BUILD_CORE
#endif /* USE_DL_EXPORT */
...
#if defined(__GNUC__) && ( defined(_WIN32) || defined(TARGET_OS_ANDROID) )
/* XXX These defines are likely incomplete, but should be easy to fix.
...
#endif // !defined(Py_NO_ENABLE_SHARED)
...
/* configure.ac defines HAVE_LARGEFILE_SUPPORT if HAVE_LONG_LONG,
