 ...
 * be included in the header include path. Simply adding <libtag/tag.h> will \e not work.
 *
 ...
 *
 *  - <a href="http://developer.kde.org/~wheeler/libtag/">TagLib Homepage</a>
