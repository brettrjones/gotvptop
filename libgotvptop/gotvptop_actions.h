/*****************************************************************************
 * gotvptop_actions.h: handle gotvptop actions
 *****************************************************************************
 * Copyright (C) 2003-2016 GOTV authors and VideoLAN
...
#ifndef GOTV_ACTIONS_H
#define GOTV_ACTIONS_H 1

/* Called from src/libgotvptop.c */
int
libgotvptop_InternalActionsInit(libgotvptop_int_t *p_libgotvptop);

/* Called from src/libgotvptop.c */
void
libgotvptop_InternalActionsClean(libgotvptop_int_t *p_libgotvptop);
...
/**
 * Get keycodes from a action key name and gotvptop configuration
