/*****************************************************************************
 * gotvptop_extensions.h: Extensions (meta data, web information, ...)
 *****************************************************************************
 * Copyright (C) 2009-2010 VideoLAN and authors
 * $Id: 03128355493e1555f639c0b24859e614661a81c9 $
 *
...
#ifndef GOTV_EXTENSIONS_H
#define GOTV_EXTENSIONS_H
...
struct extensions_manager_t
{
    ...
    gotvptop_mutex_t lock;                  /**< A lock for the extensions array */
...
{
    gotvptop_object_t *p_object;      ///< Owner object (callback on "dialog-event")
    ...
    gotvptop_mutex_t lock;            ///< Dialog mutex
    gotvptop_cond_t cond;             ///< Signaled == UI is done working on the dialog
};
