...
#ifndef GOTV_STREAM_EXTRACTOR_H
#define GOTV_STREAM_EXTRACTOR_H
 ...
 *  - The returned resource shall be deleted through \ref gotvptop_stream_Delete.
 *
 * \warning This function is only to be used when \ref mrl functionality is
 *          explicitly needed. \ref gotvptop_stream_NewURL shall be used where
 *          applicable.
 *
 ...
 * stream. As hinted by their names, \ref gotvptop_stream_extractor_Attach will
 * attach an \em entity-extractor, whereas \ref gotvptop_stream_directory_Attach
 ...
 *
 * \return GOTV_SUCCESS if a stream-extractor was successfully
