/*****************************************************************************
 * gotvptop_video_splitter.h: "video splitter" related structures and functions
 *****************************************************************************
 * Copyright (C) 2009 Laurent Aimar
 * $Id: 6e25c1e05a4145e06acd3941846a03a361231132 $
 *
...
#ifndef GOTV_VIDEO_SPLITTER_H
#define GOTV_VIDEO_SPLITTER_H 1
...
struct video_splitter_t
{
    ...
    int             (*pf_filter)( video_splitter_t *, picture_t *pp_dst[],
                                  picture_t *p_src );
    int             (*pf_mouse) ( video_splitter_t *, gotvptop_mouse_t *,
                                  int i_index,
                                  const gotvptop_mouse_t *p_old, const gotvptop_mouse_t *p_new );
 ...
 *
 * If GOTV_SUCCESS is not returned, pp_picture values are undefined.
 */
...
/* */
video_splitter_t * video_splitter_New( gotvptop_object_t *, const char *psz_name, const video_format_t * );
