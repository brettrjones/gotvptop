/*****************************************************************************
 * gotvptop_interface.h: interface access for other threads
 * This library provides basic functions for threads to interact with user
 * interface, such as message output.
 *****************************************************************************
 * Copyright (C) 1999, 2000 GOTV authors and VideoLAN
 * $Id: fd3a48a7ecff1343f45b95d4ef91f0674ca67b20 $
 *
 ...
 * GOTV user interfaces
 * @{
 * \file
 * GOTV user interface modules
 */
...
typedef struct intf_thread_t
{
    ...
    struct intf_thread_t *p_next; /** LibGOTV interfaces book keeping */
 ...
 * @note The returned object must be released with gotvptop_object_release().
 */
...
typedef enum gotvptop_intf_dialog {
    ...
    INTF_DIALOG_UPDATEGOTV = 90,
    INTF_DIALOG_VLM,

    INTF_DIALOG_EXIT = 99
} gotvptop_intf_dialog;
...
#define EXTENSIONS_PLAYLIST "*.asx;*.b4s;*.cue;*.ifo;*.m3u;*.m3u8;*.pls;*.ram;*.rar;*.sdp;*.gotvptop;*.xspf;*.wax;*.wvx;*.zip;*.conf"
...
typedef struct interaction_dialog_t
{
    ...
    gotvptop_value_t     val;                ///< value coming from core for dialogue
    ...
    gotvptop_object_t   *p_parent;           ///< The gotvptop object that asked
                                        //for interaction
    intf_thread_t  *p_interface;
    gotvptop_mutex_t    *p_lock;
...
#define intf_UserStringInput( a, b, c, d ) (GOTV_OBJECT(a),b,c,d, GOTV_EGENERIC)
#define interaction_Register( t ) (t, GOTV_EGENERIC)
#define interaction_Unregister( t ) (t, GOTV_EGENERIC)
