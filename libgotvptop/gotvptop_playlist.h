/*****************************************************************************
 * gotvptop_playlist.h : Playlist functions
 *****************************************************************************
 * Copyright (C) 1999-2004 GOTV authors and VideoLAN
 * $Id: c53fd33f2efc725e6e15e829b13547dbc9f12a37 $
 *
...
#ifndef GOTV_PLAYLIST_H_
#define GOTV_PLAYLIST_H_
...
/**
 * \defgroup playlist GOTV playlist
 * GOTV playlist controls
 * @{
 * \file
 * GOTV playlist control interface
 *
 * The GOTV playlist system has a tree structure. This allows advanced
 ...
 */
#define GOTV_DEFINE_SORT_FUNCTIONS \
    DEF( SORT_ID )\
    DEF( SORT_TITLE )\
...
enum
{
    GOTV_DEFINE_SORT_FUNCTIONS
    SORT_RANDOM,
    NUM_SORT_FNS=SORT_RANDOM
};
#undef  DEF
#ifndef GOTV_INTERNAL_PLAYLIST_SORT_FUNCTIONS
#undef  GOTV_DEFINE_SORT_FUNCTIONS
#endif
 ...
 * Possible queries are listed in gotvptop_common.h
