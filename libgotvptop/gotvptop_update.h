/*****************************************************************************
 * gotvptop_update.h: GOTV update download
 *****************************************************************************
 * Copyright © 2005-2007 GOTV authors and VideoLAN
...
#ifndef GOTV_UPDATE_H
#define GOTV_UPDATE_H

/**
 * \defgroup update Software updates
 * \ingroup interface
 * Over-the-air GOTV software updates
 * @{
 * \file
 *GOTV software update interface
 */

/**
 * Describes an update GOTV release number
 */
