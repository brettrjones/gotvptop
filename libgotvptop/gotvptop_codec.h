/*****************************************************************************
 * gotvptop_codec.h: Definition of the decoder and encoder structures
 *****************************************************************************
 * Copyright (C) 1999-2003 GOTV authors and VideoLAN
 * $Id: e8fd1f157433323d4edaa6138cead88fe55096bb $
 *
...
#   define GOTVDEC_SUCCESS   GOTV_SUCCESS
#   define GOTVDEC_ECRITICAL GOTV_EGENERIC
#   define GOTVDEC_RELOAD    (-100)
     ...
     *  GOTVDEC_SUCCESS: pf_decode will be called again
     *  GOTVDEC_ECRITICAL: in case of critical error, pf_decode won't be called
     *  again.
     *  GOTVDEC_RELOAD: Request that the decoder should be reloaded. The current
