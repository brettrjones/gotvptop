/*****************************************************************************
 * gotvptop_vout_display.h: vout_display_t definitions
 *****************************************************************************
 * Copyright (C) 2009 Laurent Aimar
 * $Id: ac2e1ca4901340e1c20af7a738d80054251aa099 $
 *
...
#ifndef GOTV_VOUT_DISPLAY_H
#define GOTV_VOUT_DISPLAY_H 1

#include <gotvptop_es.h>
#include <gotvptop_picture.h>
#include <gotvptop_picture_pool.h>
#include <gotvptop_subpicture.h>
#include <gotvptop_actions.h>
#include <gotvptop_mouse.h>
#include <gotvptop_vout.h>
#include <gotvptop_vout_window.h>
#include <gotvptop_viewpoint.h>
...
typedef struct {
    ...
    bool is_fullscreen GOTV_DEPRECATED;  /* Is the display fullscreen */
#endif
    ...
    gotvptop_viewpoint_t viewpoint;
} vout_display_cfg_t;
...
typedef struct {
    ...
    const gotvptop_fourcc_t *subpicture_chromas; /* List of supported chromas for subpicture rendering. */
} vout_display_info_t;
...
enum {
    ...
    VOUT_DISPLAY_HIDE_MOUSE GOTV_DEPRECATED_ENUM,
    ...
    VOUT_DISPLAY_CHANGE_FULLSCREEN GOTV_DEPRECATED_ENUM,     /* bool fs */
    ...
    VOUT_DISPLAY_CHANGE_WINDOW_STATE GOTV_DEPRECATED_ENUM,   /* unsigned state */
#endif
...
struct vout_display_t {
    ...
    void       (*manage)(vout_display_t *) GOTV_DEPRECATED;
