/*****************************************************************************
 * gotvptop_fixups.h: portability fixups included from config.h
 *****************************************************************************
...
#ifndef LIBGOTV_FIXUPS_H
# define LIBGOTV_FIXUPS_H 1
...
/* unistd.h */
#ifndef HAVE_GETPID
pid_t getpid (void) GOTV_NOTHROW;
#endif
...
/* libintl support */
#define _(str)            gotvptop_gettext (str)
...
void gotvptop_tdestroy( void *, void (*)(void *) );
#  define tdestroy gotvptop_tdestroy
# endif
#endif
...
#ifdef _WIN32
FILE *gotvptop_win32_tmpfile(void);
#endif
