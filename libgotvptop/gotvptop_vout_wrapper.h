/*****************************************************************************
 * gotvptop_vout_wrapper.h: definitions for vout wrappers (temporary)
 *****************************************************************************
...
#ifndef GOTV_VOUT_WRAPPER_H
#define GOTV_VOUT_WRAPPER_H 1

#include <gotvptop_vout_display.h>
...
void vout_SetDisplayViewpoint(vout_display_t *, const gotvptop_viewpoint_t *);

#endif /* GOTV_VOUT_WRAPPER_H */
