/*****************************************************************************
 * gotvptop_picture.h: picture definitions
 *****************************************************************************
 * Copyright (C) 1999 - 2009 GOTV authors and VideoLAN
 * $Id: 1ab8fef14f58da19022819da54340067be45948a $
 *
...
#ifndef GOTV_PICTURE_H
#define GOTV_PICTURE_H 1

/**
 * \file
 * This file defines picture structures and functions in gotvptop
 */
 ...
 *
 * It will return GOTV_EGENERIC if the core does not understand the requested
 * format.
 *
