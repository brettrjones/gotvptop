/*****************************************************************************
 * gotvptop_subpicture.h: subpicture definitions
 *****************************************************************************
...
#ifndef GOTV_SUBPICTURE_H
#define GOTV_SUBPICTURE_H 1

/**
 */

#include <gotvptop_picture.h>
#include <gotvptop_text_style.h>
...
typedef struct
{
    /** Optional pre update callback, usually useful on video format change.
      * Will skip pf_update on GOTV_SUCCESS, or will delete every region before
