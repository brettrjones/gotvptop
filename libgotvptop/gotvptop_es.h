/*****************************************************************************
 * gotvptop_es.h: Elementary stream formats descriptions
 *****************************************************************************
 * Copyright (C) 1999-2012 GOTV authors and VideoLAN
 * $Id: 718dfc42b14c77fefd566bbaeb005e2883343729 $
 *
...
{
    gotvptop_fourcc_t i_format;                          /**< audio format fourcc */
...
{
    gotvptop_fourcc_t i_chroma;                               /**< picture chroma */
 ...
 */
static inline void video_format_Init( video_format_t *p_src, gotvptop_fourcc_t i_chroma )
{
    memset( p_src, 0, sizeof( video_format_t ) );
    p_src->i_chroma = i_chroma;
    gotvptop_viewpoint_init( &p_src->pose );
}
...
struct es_format_t
{
    ...
    gotvptop_fourcc_t    i_codec;            /**< FOURCC value as used in gotvptop */
    gotvptop_fourcc_t    i_original_fourcc;  /**< original FOURCC from the container */
 ...
 */
static inline void es_format_Change( es_format_t *fmt, int i_cat, gotvptop_fourcc_t i_codec )
{
    es_format_Clean( fmt );
