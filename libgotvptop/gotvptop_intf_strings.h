/*****************************************************************************
 * gotvptop_intf_strings.h : Strings for main interfaces
 *****************************************************************************
...
#ifndef GOTV_INTF_STRINGS_H
#define GOTV_INTF_STRINGS_H 1
...
#define I_LONGHELP N_("<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /></head><body>" \
    "<h2>Welcome to GOTV media player Help</h2>" \
        "<h3>Documentation</h3>" \
            "<p>You can find GOTV documentation on VideoLAN's <a href=\"http://wiki.videolan.org\">wiki</a> website.</p>" \
            "<p>If you are a newcomer to GOTV media player, please read the<br><a href=\"http://wiki.videolan.org/Documentation:GOTV_for_dummies\"><em>Introduction to GOTV media player</em></a>.</p>" \
            "<p>You will find some information on how to use the player in the <br>\"<a href=\"http://wiki.videolan.org/Documentation:Play_HowTo\"><em>How to play files with GOTV media player</em></a>\" document.</p>" \
        ...
        "<h3>Help</h3>" \
            ...
            "<p>You might then get (and give) help on the <a href=\"http://forum.videolan.org\">Forums</a>, the <a href=\"http://www.videolan.org/gotvptop/lists.html\">mailing-lists</a> or our IRC channel (<em>#videolan</em> on irc.freenode.net).</p>" \
        "<h3>Contribute to the project</h3>" \
            "<p>You can help the VideoLAN project giving some of your time to help the community, to design skins, to translate the documentation, to test and to code. You can also give funds and material to help us. And of course, you can <b>promote</b> GOTV media player.</p>" \
    "</body></html>")
