/*****************************************************************************
 * gotvptop_codecs.h: codec related structures needed by the demuxers and decoders
 *****************************************************************************
 * Copyright (C) 1999-2001 GOTV authors and VideoLAN
...
#ifndef GOTV_CODECS_H
#define GOTV_CODECS_H 1
...
#ifndef _GOTV_BITMAPINFOHEADER_
#define _GOTV_BITMAPINFOHEADER_
...
} GOTV_BITMAPINFOHEADER, *GOTV_PBITMAPINFOHEADER, *GOTV_LPBITMAPINFOHEADER;

typedef struct
ATTR_PACKED
{
    GOTV_BITMAPINFOHEADER bmiHeader;
    int                  bmiColors[1];
} GOTV_BITMAPINFO, *GOTV_LPBITMAPINFO;
#endif
...
/* GUID SubFormat IDs */
#define GOTV_KSDATAFORMAT_SUBTYPE_ATRAC3P {0xE923AABF, 0xCB58, 0x4471, {0xA1, 0x19, 0xFF, 0xFA, 0x01, 0xE4, 0xCE, 0x62}} /* Undocumented */
#define GOTV_KSDATAFORMAT_SUBTYPE_UNKNOWN {0x00000000, 0x0000, 0x0000, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}
#define GOTV_WAVEFORMATEX_GUIDBASE        {0x00000000, 0x0000, 0x0010, {0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}} /* Generated from Wave Format */
#define GOTV_AMBISONIC_SUBTYPE_PCM        {0x00000001, 0x0721, 0x11D3, {0x86, 0x44, 0xC8, 0xC1, 0xCA, 0x00, 0x00, 0x00}} /* AMBISONIC_B_FORMAT_PCM */
#define GOTV_AMBISONIC_SUBTYPE_IEEE_FLOAT {0x00000003, 0x0721, 0x11D3, {0x86, 0x44, 0xC8, 0xC1, 0xCA, 0x00, 0x00, 0x00}} /* AMBISONIC_B_FORMAT_IEEE_FLOAT */
...
{
    uint16_t     i_tag;
    gotvptop_fourcc_t i_fourcc;
    const char  *psz_name;
}
wave_format_tag_to_fourcc[] =
{
    { WAVE_FORMAT_PCM,              GOTV_FOURCC( 'a', 'r', 'a', 'w' ), "Raw audio" },
    { WAVE_FORMAT_PCM,              GOTV_CODEC_S8,                     "PCM S8 audio" },
    { WAVE_FORMAT_PCM,              GOTV_CODEC_S16L,                   "PCM S16L audio" },
    { WAVE_FORMAT_PCM,              GOTV_CODEC_S24L,                   "PCM S24L audio" },
    { WAVE_FORMAT_PCM,              GOTV_CODEC_S32L,                   "PCM S32L audio" },
    { WAVE_FORMAT_ADPCM,            GOTV_CODEC_ADPCM_MS,               "ADPCM" },
    { WAVE_FORMAT_IEEE_FLOAT,       GOTV_FOURCC( 'a', 'f', 'l', 't' ), "IEEE Float audio" },
    { WAVE_FORMAT_IEEE_FLOAT,       GOTV_CODEC_F32L,                   "PCM 32 (Float) audio" },
    { WAVE_FORMAT_IEEE_FLOAT,       GOTV_CODEC_F64L,                   "PCM 64 (Float) audio" },
    { WAVE_FORMAT_ALAW,             GOTV_CODEC_ALAW,                   "A-Law" },
    { WAVE_FORMAT_MULAW,            GOTV_CODEC_MULAW,                  "Mu-Law" },
    { WAVE_FORMAT_IMA_ADPCM,        GOTV_CODEC_ADPCM_IMA_WAV,          "Ima-ADPCM" },
    { WAVE_FORMAT_CREATIVE_ADPCM,   GOTV_CODEC_ADPCM_CREATIVE,         "Creative ADPCM" },
    { WAVE_FORMAT_YAMAHA_ADPCM,     GOTV_CODEC_ADPCM_YAMAHA,           "Yamaha ADPCM" },
    { WAVE_FORMAT_TRUESPEECH,       GOTV_CODEC_TRUESPEECH,             "Truespeech" },
    { WAVE_FORMAT_GSM610,           GOTV_CODEC_GSM_MS,                 "Microsoft WAV GSM" },
    { WAVE_FORMAT_MSNAUDIO,         GOTV_CODEC_GSM_MS,                 "Microsoft MSN Audio" },
    { WAVE_FORMAT_G726,             GOTV_CODEC_ADPCM_G726,             "G.726 ADPCM" },
    { WAVE_FORMAT_G726_ADPCM,       GOTV_CODEC_ADPCM_G726,             "G.726 ADPCM" },
    { WAVE_FORMAT_G723_1,           GOTV_CODEC_G723_1,                 "G.723.1" },
    { WAVE_FORMAT_MSG723,           GOTV_CODEC_G723_1,                 "Microsoft G.723 [G723.1]" },
    { WAVE_FORMAT_VIVOG723,         GOTV_CODEC_G723_1,                 "Vivo G.723.1" },
    { WAVE_FORMAT_MPEGLAYER3,       GOTV_CODEC_MP3,                    "Mpeg Audio Layer 3" },
    { WAVE_FORMAT_MPEG,             GOTV_CODEC_MPGA,                   "Mpeg Audio" },
    { WAVE_FORMAT_AMR_NB,           GOTV_CODEC_AMR_NB,                 "AMR NB" },
    { WAVE_FORMAT_AMR_NB_2,         GOTV_CODEC_AMR_NB,                 "AMR NB" },
    { WAVE_FORMAT_AMR_WB,           GOTV_CODEC_AMR_WB,                 "AMR Wideband" },
    { WAVE_FORMAT_SIPRO,            GOTV_CODEC_SIPR,                   "Sipr Audio" },
    { WAVE_FORMAT_A52,              GOTV_CODEC_A52,                    "A/52" },
    { WAVE_FORMAT_WMA1,             GOTV_CODEC_WMA1,                   "Window Media Audio v1" },
    { WAVE_FORMAT_WMA2,             GOTV_CODEC_WMA2,                   "Window Media Audio v2" },
    { WAVE_FORMAT_WMAP,             GOTV_CODEC_WMAP,                   "Window Media Audio 9 Professional" },
    { WAVE_FORMAT_WMAL,             GOTV_CODEC_WMAL,                   "Window Media Audio 9 Lossless" },
    { WAVE_FORMAT_WMAS,             GOTV_CODEC_WMAS,                   "Window Media Audio 9 Speech" },
    { WAVE_FORMAT_ATRAC3,           GOTV_CODEC_ATRAC3,                 "Sony Atrac3" },
    { WAVE_FORMAT_SONY_ATRAC3,      GOTV_CODEC_ATRAC3,                 "Sony Atrac3" },
    { WAVE_FORMAT_DK3,              GOTV_CODEC_ADPCM_DK3,              "Duck DK3" },
    { WAVE_FORMAT_DK4,              GOTV_CODEC_ADPCM_DK4,              "Duck DK4" },
    { WAVE_FORMAT_DTS,              GOTV_CODEC_DTS,                    "DTS Coherent Acoustics" },
    { WAVE_FORMAT_DTS_MS,           GOTV_CODEC_DTS,                    "DTS Coherent Acoustics" },
    { WAVE_FORMAT_DIVIO_AAC,        GOTV_CODEC_MP4A,                   "MPEG-4 Audio (Divio)" },
    { WAVE_FORMAT_AAC,              GOTV_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_QNAP_ADTS,        GOTV_CODEC_MP4A,                   "MPEG-4 ADTS Audio" },
    { WAVE_FORMAT_AAC_ADTS,         GOTV_CODEC_MP4A,                   "MPEG-4 ADTS Audio" },
    { WAVE_FORMAT_AAC_2,            GOTV_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AAC_3,            GOTV_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AAC_LATM,         GOTV_CODEC_MP4A,                   "MPEG-4 LATM Audio" },
    { WAVE_FORMAT_HEAAC,            GOTV_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AVCODEC_AAC,      GOTV_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AAC_MS,           GOTV_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_VORBIS,           GOTV_CODEC_VORBIS,                 "Vorbis Audio" },
    { WAVE_FORMAT_VORB_1,           GOTV_FOURCC( 'v', 'o', 'r', '1' ), "Vorbis 1 Audio" },
    { WAVE_FORMAT_VORB_1PLUS,       GOTV_FOURCC( 'v', 'o', '1', '+' ), "Vorbis 1+ Audio" },
    { WAVE_FORMAT_VORB_2,           GOTV_FOURCC( 'v', 'o', 'r', '2' ), "Vorbis 2 Audio" },
    { WAVE_FORMAT_VORB_2PLUS,       GOTV_FOURCC( 'v', 'o', '2', '+' ), "Vorbis 2+ Audio" },
    { WAVE_FORMAT_VORB_3,           GOTV_FOURCC( 'v', 'o', 'r', '3' ), "Vorbis 3 Audio" },
    { WAVE_FORMAT_VORB_3PLUS,       GOTV_FOURCC( 'v', 'o', '3', '+' ), "Vorbis 3+ Audio" },
    { WAVE_FORMAT_SPEEX,            GOTV_CODEC_SPEEX,                  "Speex Audio" },
    { WAVE_FORMAT_FLAC,             GOTV_CODEC_FLAC,                   "FLAC Audio" },
    { WAVE_FORMAT_GSM_AMR_FIXED,    GOTV_CODEC_AMR_NB,                 "GSM-AMR Audio CBR, no SID" },
    { WAVE_FORMAT_GSM_AMR,          GOTV_CODEC_AMR_NB,                 "GSM-AMR Audio VBR, SID" },
    { WAVE_FORMAT_ULEAD_DV_AUDIO_NTSC, GOTV_CODEC_ULEAD_DV_AUDIO_NTSC, "Ulead DV audio NTSC" },
    { WAVE_FORMAT_ULEAD_DV_AUDIO_PAL, GOTV_CODEC_ULEAD_DV_AUDIO_PAL,   "Ulead DV audio PAL" },
    { WAVE_FORMAT_IMC,              GOTV_CODEC_IMC,                    "IMC" },
    { WAVE_FORMAT_INDEO_AUDIO,      GOTV_CODEC_INDEO_AUDIO,            "Indeo Audio Coder" },
    { WAVE_FORMAT_VOXWARE_RT29,     GOTV_CODEC_METASOUND,              "VoxWare MetaSound" },
    { WAVE_FORMAT_ON2_AVC,          GOTV_CODEC_ON2AVC,                 "On2 Audio for Video Codec (VP7)" },
    { WAVE_FORMAT_ON2_AVC_2,        GOTV_CODEC_ON2AVC,                 "On2 Audio for Video Codec (VP6)" },

    { WAVE_FORMAT_UNKNOWN,          GOTV_CODEC_UNKNOWN,                "Unknown" }
};

static inline void wf_tag_to_fourcc( uint16_t i_tag, gotvptop_fourcc_t *fcc,
...
static inline void fourcc_to_wf_tag( gotvptop_fourcc_t fcc, uint16_t *pi_tag )
{
    int i;
    for( i = 0; wave_format_tag_to_fourcc[i].i_tag != 0; i++ )
    {
...
{
    const GUID   guid_tag;
    const gotvptop_fourcc_t i_fourcc;
    const char  *psz_name;
}
sub_format_tag_to_fourcc[] =
{
    { GOTV_AMBISONIC_SUBTYPE_PCM,        GOTV_FOURCC( 'a', 'r', 'a', 'w' ), "Ambisonic B format (PCM)" },
    { GOTV_AMBISONIC_SUBTYPE_IEEE_FLOAT, GOTV_FOURCC( 'a', 'f', 'l', 't' ), "Ambisonic B format (IEEE float)" },
    { GOTV_KSDATAFORMAT_SUBTYPE_ATRAC3P, GOTV_CODEC_ATRAC3P,                "Sony Atrac3+" },
    { GOTV_KSDATAFORMAT_SUBTYPE_UNKNOWN, GOTV_CODEC_UNKNOWN,      "Unknown" }
};
...
static inline void sf_tag_to_fourcc( const GUID *guid_tag,
                                     gotvptop_fourcc_t *fcc, const char **ppsz_name )
{
    int i;
    bool b_found = false;

    const GUID unknown = GOTV_KSDATAFORMAT_SUBTYPE_UNKNOWN;
    const GUID waveformatex = GOTV_WAVEFORMATEX_GUIDBASE;
