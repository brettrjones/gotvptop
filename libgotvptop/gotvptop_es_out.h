/*****************************************************************************
 * gotvptop_es_out.h: es_out (demuxer output) descriptor, queries and methods
 *****************************************************************************
...
#ifndef GOTV_ES_OUT_H
#define GOTV_ES_OUT_H 1
...
enum es_out_query_e
{
    ...
    /* Set meta data for group (dynamic) (The gotvptop_meta_t is not modified nor released) */
    ES_OUT_SET_GROUP_META,  /* arg1=int i_group arg2=const gotvptop_meta_t */
    /* Set epg for group (dynamic) (The gotvptop_epg_t is not modified nor released) */
    ES_OUT_SET_GROUP_EPG,       /* arg1=int i_group arg2=const gotvptop_epg_t * */
    ES_OUT_SET_GROUP_EPG_EVENT, /* arg1=int i_group arg2=const gotvptop_epg_event_t * */
    ...
    /* Set global meta data (The gotvptop_meta_t is not modified nor released) */
    ES_OUT_SET_META, /* arg1=const gotvptop_meta_t * */
...
static inline int es_out_ControlSetMeta( es_out_t *out, const gotvptop_meta_t *p_meta )
{
