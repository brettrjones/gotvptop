/*****************************************************************************
 * gotvptop_gcrypt.h: GOTV thread support for gcrypt
 *****************************************************************************
...
/**
 * \file
 * This file implements gcrypt support functions in gotvptop
 */

#include <errno.h>

static inline void gotvptop_gcrypt_init (void)
{
    ...
    gotvptop_global_lock (GOTV_GCRYPT_MUTEX);
    if (!done)
    {
    ...
    gotvptop_global_unlock (GOTV_GCRYPT_MUTEX);
}
