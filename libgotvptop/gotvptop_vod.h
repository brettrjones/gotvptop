/*****************************************************************************
 * gotvptop_vod.h: interface for VoD server modules
 *****************************************************************************
 * Copyright (C) 2000, 2001 GOTV authors and VideoLAN
 * $Id: 37fee2b810bb5f0db9a7657a00a0bf2c0e16dc0d $
 *
                                    ...
                                    const char *psz_id, int i_query, ... )
{
    ...
    if( !p_vod->pf_media_control ) return GOTV_EGENERIC;
