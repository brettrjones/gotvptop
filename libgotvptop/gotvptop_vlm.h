/*****************************************************************************
 * gotvptop_vlm.h: VLM core structures
 *****************************************************************************
 * Copyright (C) 2000, 2001 GOTV authors and VideoLAN
 ...
 * GOTV stream manager
 *
 * VLM is the server core in gotvptop that allows streaming of multiple media streams
...
typedef struct
{
    ...
    struct
    {
        bool b_loop;    /*< this gotvptop_media_t broadcast item should loop */
