...
class Filesystem {
 public:
  static FilesystemInterface *default_filesystem() {
    vx_assert(default_filesystem_ != NULL);
...
class FilesystemScope{
 ...
 private:
  ...
  FilesystemScope(const FilesystemScope&);
  void operator=(const FilesystemScope&);
};
