...
class SCOPED_LOCKABLE CritScope {
 ...
 private:
  ...
  CritScope(const CritScope&);
  void operator=(const CritScope&);
};
...
class TryCritScope {
 ...
 private:
  ...
  TryCritScope(const TryCritScope&);
  void operator=(const TryCritScope&);
};
...
class SCOPED_LOCKABLE GlobalLockScope {
 ...
 private:
  ...
  GlobalLockScope(const GlobalLockScope&);
  void operator=(const GlobalLockScope&);
};
