...
, xfBufBlockPos( 0 )
, far_time_buf( 0 )
, system_delay( 0 )  // Current system delay buffered in AEC.
, mult( 0 )  // sampling frequency multiple
, sampFreq( 0 ) // = 16000( 0 )
, num_bands( 0 )
, seed(0)
, filter_step_size( 0 )  // stepsize
, error_threshold( 0 )   // error threshold
, noiseEstCtr( 0 )
, metricsMode( 0 )
, stateCounter( 0 )
, freq_avg_ic( 0 )       // initial bin for averaging nlp gain
, flag_Hband_cn( 0 )     // for comfort noise
, cn_scale_Hband(0.0f)// scale for comfort noise in H band
, delay_metrics_delivered( 0 )
, num_delay_values( 0 )
, delay_median( 0 )
, delay_std( 0 )
, fraction_poor_delays(0.0f)
, delay_logging_enabled( 0 )
, delay_estimator_farend( 0 )
, delay_estimator( 0 )
, signal_delay_correction( 0 )
, previous_delay( 0 )
, delay_correction_count( 0 )
, shift_offset( 0 )
, delay_quality_threshold(0.0f)
, frame_count( 0 )
, delay_agnostic_enabled( 0 )
, extended_filter_enabled( 0 )
, aec3_enabled( 0 )
, refined_adaptive_filter_enabled( false )
, num_partitions( 0 )
...
#if defined(CPU_ARCH_X86_FAMILY)
...
int WebRtcAec_InitAec(AecCore* aec, int sampFreq) {
  ...
  aec->num_partitions = aec->extended_filter_enabled ? kExtendedNumPartitions : kNormalNumPartitions;
