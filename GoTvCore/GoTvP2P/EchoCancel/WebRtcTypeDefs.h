...
#define WEBRTC_ARCH_64_BITS
#define WEBRTC_ARCH_LITTLE_ENDIAN
#elif defined(_M_IX86) || defined(__i386__) || defined(TARGET_OS_WINDOWS)
#define CPU_ARCH_X86_FAMILY
#define WEBRTC_ARCH_X86
#define WEBRTC_ARCH_32_BITS
#define WEBRTC_ARCH_LITTLE_ENDIAN
#elif defined(__ARMEL__)
//NOTE: this is defined for android arm-7
#define WEBRTC_ARCH_ARM_FAMILY
#define WEBRTC_ARCH_32_BITS
#define WEBRTC_ARCH_LITTLE_ENDIAN
...
#if (defined(CPU_ARCH_X86_FAMILY) && !defined(__SSE2__)) || \
...
//#define nullptr 0 // commented out because causes issues with visual studio 2015 redefinition
