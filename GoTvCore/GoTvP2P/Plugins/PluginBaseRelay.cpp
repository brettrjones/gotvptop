...
//============================================================================
void PluginBaseRelay::fromGuiRelayPermissionCount( int userPermittedCount, int anonymousCount )
{
...
void PluginBaseRelay::onSessionEnded( PluginSessionBase * poSession, bool pluginIsLocked, EOfferResponse eOfferResponse )
{
...
bool PluginBaseRelay::fromGuiMakePluginOffer(	VxNetIdent *	netIdent, 
											int				pvUserData, 
											...
											VxGUID			lclSessionId )
{
	...
	if( 0 == strcmp( pOfferMsg, "ActionTest" ) )
	{
		...
		*/
		...
		LogMsg( LOG_INFO, "PluginBaseRelay::fromGuiMakePluginOffer: doRelayTest done\n" );
	}
	else
	{
		LogMsg( LOG_ERROR, "PluginBaseRelay::fromGuiMakePluginOffer: Invalid Offer\n" );
	}
	return bOfferSent;
}

//============================================================================
RelaySession * PluginBaseRelay::startNewRelayService( VxSktBase * sktBase, VxNetIdent * netIdent, VxGUID& rmtInstance )
{
...
//============================================================================
RelaySession * PluginBaseRelay::startNewRelayClient( VxSktBase * sktBase, VxNetIdent * netIdent, VxGUID& rmtInstance )
{
...
//============================================================================
RelaySession * PluginBaseRelay::requestRelayService( VxNetIdent * netIdent, RelayClientSession * poSessionIn, bool bTest )
{
...
//============================================================================
RelayClientSession * PluginBaseRelay::findOrCreateRelayClient( VxSktBase * sktBase, VxNetIdent * netIdent )
{
...
//============================================================================
RelayServerSession * PluginBaseRelay::findOrCreateRelayServer(  VxSktBase * sktBase, VxNetIdent * netIdent )
{
...
//============================================================================
void PluginBaseRelay::replaceConnection( VxNetIdent * netIdent, VxSktBase * poOldSkt, VxSktBase * poNewSkt )
{
	m_PluginSessionMgr.replaceConnection( netIdent, poOldSkt, poNewSkt );
}

//============================================================================
void PluginBaseRelay::onContactWentOffline( VxNetIdent * netIdent, VxSktBase * sktBase )
{
...
//============================================================================
void PluginBaseRelay::onConnectionLost( VxSktBase * sktBase )
{
