...
//============================================================================
PluginRelay::PluginRelay( P2PEngine& engine, PluginMgr& pluginMgr, IToGui& toGui, VxNetIdent * myIdent )
...
//============================================================================
void PluginRelay::fromGuiRelayPermissionCount( int userPermittedCount, int anonymousCount )
{
...
//============================================================================
EPluginAccessState PluginRelay::canAcceptNewSession( VxNetIdent * netIdent )
{
...
//============================================================================
bool PluginRelay::isUserRelayOk( VxGUID& srcOnlineId, VxGUID& destOnlineId )
{
...
//============================================================================
EPluginAccessState PluginRelay::handlePktRelayServiceReq( BigListInfo * bigListInfo, VxSktBase * sktBase, PktRelayServiceReq * relayServiceReq, PktRelayServiceReply& pktReply )
{
...
void PluginRelay::onSessionEnded( PluginSessionBase * poSession, bool pluginIsLocked, EOfferResponse eOfferResponse )
{
...
bool PluginRelay::fromGuiMakePluginOffer(	VxNetIdent *	netIdent, 
											int				pvUserData, 
											...
											VxGUID			lclSessionId )
{
	...
	if( 0 == strcmp( pOfferMsg, "ActionTest" ) )
	{
		...
		*/
		...
		LogMsg( LOG_INFO, "PluginRelay::fromGuiMakePluginOffer: doRelayTest done\n" );
	}
	else
	{
		LogMsg( LOG_ERROR, "PluginRelay::fromGuiMakePluginOffer: Invalid Offer\n" );
	}
	return bOfferSent;
}

//============================================================================
RelaySession * PluginRelay::startNewRelayService( VxSktBase * sktBase, VxNetIdent * netIdent, VxGUID& rmtInstance )
{
...
//============================================================================
RelaySession * PluginRelay::startNewRelayClient( VxSktBase * sktBase, VxNetIdent * netIdent, VxGUID& rmtInstance )
{
...
//============================================================================
RelaySession * PluginRelay::requestRelayService( VxNetIdent * netIdent, RelayClientSession * poSessionIn, bool bTest )
{
...
//============================================================================
PluginSessionBase * PluginRelay::findRelay( VxGUID& onlineId )
{
...
//============================================================================
RelayClientSession * PluginRelay::findOrCreateRelayClient( VxSktBase * sktBase, VxNetIdent * netIdent )
{
...
//============================================================================
RelayServerSession * PluginRelay::findOrCreateRelayServer(  VxSktBase * sktBase, VxNetIdent * netIdent )
{
...
//============================================================================
void PluginRelay::replaceConnection( VxNetIdent * netIdent, VxSktBase * poOldSkt, VxSktBase * poNewSkt )
{
	m_PluginSessionMgr.replaceConnection( netIdent, poOldSkt, poNewSkt );
}

//============================================================================
void PluginRelay::onContactWentOffline( VxNetIdent * netIdent, VxSktBase * sktBase )
{
...
//============================================================================
void PluginRelay::onConnectionLost( VxSktBase * sktBase )
{
