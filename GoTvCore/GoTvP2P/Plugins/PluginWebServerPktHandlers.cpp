...
//============================================================================
void PluginWebServer::replaceConnection( VxNetIdent * netIdent, VxSktBase * poOldSkt, VxSktBase * poNewSkt )
{
	WebTxIter iter;
	AutoPluginLock( this );
...
//============================================================================
void PluginWebServer::onContactWentOffline(  VxNetIdent * netIdent, VxSktBase * sktBase )
{
	AutoPluginLock( this );
	bool bErased = true;
...
//============================================================================
void PluginWebServer::onConnectionLost( VxSktBase * sktBase )
{
	AutoPluginLock( this );
	bool bErased = true;
	while( bErased ) 
...
//============================================================================
RCODE PluginWebServer::handleDataFromLocalBrowser( RcWebSkt * sktBase )
{
	RCODE rc = 0;
...
RCODE PluginWebServer::sendHttpErr(		bool				bIsGetData,				// if true use PktWebServerGetChunkTx else use PktWebServerPutChunkTx
										VxNetIdent *		netIdent, 
										VxSktBase *			sktBase, 
										int					iErrIdx )
{
...
//============================================================================
RCODE PluginWebServer::sendWebServerData(	bool					bIsGetData,				// if true use PktWebServerGetChunkTx else use PktWebServerPutChunkTx
											VxNetIdent *			netIdent, 
...
RCODE PluginWebServer::queWebsiteFile(		RcWebSkt *		poWebSkt,			//
...
//============================================================================
void PluginWebServer::onPktPluginOfferReq( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{

}

//============================================================================
void PluginWebServer::onPktPluginOfferReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
}

//============================================================================
void PluginWebServer::onPktSessionStartReq( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	LogMsg( LOG_ERROR, "PluginWebServer::onPktSessionStartReq" );
}
//============================================================================
void PluginWebServer::onPktSessionStartReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	LogMsg( LOG_ERROR, "PluginWebServer::onPktSessionStartReply" );
}
//============================================================================
void PluginWebServer::onPktSessionStopReq( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	LogMsg( LOG_ERROR, "PluginWebServer::onPktSessionStopReq" );
}
//============================================================================
void PluginWebServer::onPktSessionStopReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	LogMsg( LOG_ERROR, "PluginWebServer::onPktSessionStopReply" );
}

//============================================================================
void PluginWebServer::onPktMyPicSendReq( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
...
//============================================================================
void PluginWebServer::sendNextPicChunk( VxSktBase * sktBase, VxNetIdent * netIdent, WebTxSession * poSession )
{
...
//============================================================================
void PluginWebServer::onPktMyPicSendReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
...
//============================================================================
void PluginWebServer::onPktWebServerPicChunkTx( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{	
	...
	else
	{
		...
		if( iter != m_WebRxSessions.end() )
		{
				...
				(poSession->m_u32PicTotalDataLen >= (poSession->m_u32PicDataIdx + poPktPicChunk->getThisDataLen() ) ) )
			{
				...
				{
					LogMsg( LOG_ERROR, "PluginWebServer::onPktWebServerPicChunkTx\n");
		...
		{
			LogMsg( LOG_ERROR, "PluginWebServer::onPktWebServerPicChunkTx Error\n");
...
//============================================================================
void PluginWebServer::onPktWebServerPicChunkAck( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
...
//============================================================================
void PluginWebServer::onPktWebServerGetChunkTx( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{	
...
//============================================================================
void PluginWebServer::onPktWebServerGetChunkAck( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	WebTxIter iter = m_WebTxSessions.find(netIdent);
	if( iter != m_WebTxSessions.end() )
	{
...
//============================================================================
void PluginWebServer::onPktWebServerPutChunkTx( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{	
...
//============================================================================
void PluginWebServer::onPktWebServerPutChunkAck( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	WebTxIter iter = m_WebTxSessions.find(netIdent);
	if( iter != m_WebTxSessions.end() )
	{
