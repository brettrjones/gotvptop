...
//============================================================================
void PluginRelay::onPktRelayServiceReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
...
//				m_PluginMgr.pluginApiLog( m_ePluginType, "%3.3f Relay Is Busy ERROR", m_TestTimer.elapsedSec() );
	...
	{
		LogMsg( LOG_ERROR, "PluginRelay::onEnginePktRelayServiceReply: Session NOT FOUND" );
	}
...
//============================================================================
void PluginRelay::onPktRelayConnectReq( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
    //PktRelayConnectReq * poPkt = (PktRelayConnectReq *)pktHdr;
}

//============================================================================
void PluginRelay::onPktRelayConnectReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
    //PktRelayConnectReply * poPkt = (PktRelayConnectReply *)pktHdr;
}

//============================================================================
void PluginRelay::onPktRelaySessionReq( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
...
//============================================================================
void PluginRelay::onPktRelaySessionReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	PktRelaySessionReply * poPkt = (PktRelaySessionReply *)pktHdr;
	RelaySession * poSession = (RelaySession *)m_PluginSessionMgr.findPluginSessionBySessionId( poPkt->getRmtSessionId(), false );
	if( NULL == poSession )
	{
		LogMsg( LOG_ERROR, "PluginRelay::onPktRelaySessionReply: Session NOT FOUND" );
		if( m_bTest && m_bVerbose )
		{
...
//============================================================================
void PluginRelay::onPktRelayConnect( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
}

//============================================================================
void PluginRelay::onPktRelayDisconnect( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
}

//============================================================================
void PluginRelay::onPktRelayTestReq( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
	...
	if( netIdent->isHisAccessAllowedFromMe( m_ePluginType ) )
	{
		...
		{
			LogMsg( LOG_DEBUG, "PluginRelay::onPktRelayTestReq FAILED sending reply to %s\n", netIdent->getOnlineName() );
		}
	}
	else
	{
		LogMsg( LOG_ERROR, "PluginRelay::onPktRelayTestReq insufficient permission %s\n", netIdent->getOnlineName() );
	}
	...
	//else
	//{
	//	LogMsg( LOG_ERROR, "PluginRelay::onPktRelayTestReq: Session NOT FOUND" );
	//}
}

//============================================================================
void PluginRelay::onPktRelayTestReply( VxSktBase * sktBase, VxPktHdr * pktHdr, VxNetIdent * netIdent )
{
