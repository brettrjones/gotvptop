...
//=== tests ===//
//============================================================================
bool PluginRelay::doRelayTest( VxNetIdent * netIdent )
{
	bool bResult = false;
	VxSktBase * sktBase;
	...
	{
		LogMsg( LOG_INFO, "PluginRelay::doTests: missing contact 0x%x, 0x%x 0x%x\n", poLclIdent, poRmtIdent, poContactIdent );
		onTestComplete();	
	}
...
//============================================================================
bool PluginRelay::onTestAll(	RelayClientTestSession * poClientSession, 
...
//============================================================================
void PluginRelay::onTestComplete( void )
{
	m_PluginSessionMgr.removeAllSessions( true );
}

//============================================================================
bool PluginRelay::onTestServerClient(	RelayClientTestSession * poClientSession, 
										RelayServerTestSession * poServerSession, 
										VxNetIdent * poLclIdent, 
										VxNetIdent * poRmtIdent )
{
...
bool PluginRelay::onTestRequestRelayService(	RelayClientTestSession * poClientSession,
												VxNetIdent * netIdent )
{
	// send proxy request
...
bool PluginRelay::onTestAcceptRelayServiceRequest( VxNetIdent * netIdent )
{
	// send proxy request
	// if proxy request is ok sent test packet
	// test packet returns with same identity id then the test success
...
bool PluginRelay::onTestConnectUsingLclRelay( RelaySession * poSession, VxNetIdent * poIdentRelay )
{
	// send proxy request
	// if proxy request is ok sent test packet
...
bool PluginRelay::onTestConnectUsingRmtRelay( VxNetIdent * netIdent )
{
