...
class HostListTxSession : public HostListXferSession
{
public:
	HostListTxSession( P2PEngine& engine );
	HostListTxSession( P2PEngine& engine, VxSktBase * sktBase, VxNetIdent * netIdent );
	HostListTxSession( P2PEngine& engine, VxGUID& lclSessionId, VxSktBase * sktBase, VxNetIdent * netIdent );
