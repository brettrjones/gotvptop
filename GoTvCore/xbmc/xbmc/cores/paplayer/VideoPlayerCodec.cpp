...
int VideoPlayerCodec::ReadPCM( unsigned char *pBuffer, int size, int *actualsize )
{
    ...
    if( m_nDecodedLen > 0 )
    {
        ...
        *actualsize = nLen;
        if( m_needConvert )
        {
            //if( testPlayStarted )
            //{
            //    uint8_t * dataDmp = &m_audioFrame.data[ 0 ][ 0 ];
            //    if( playFrameCnt == 1 )
            //    {
            //        dataDmp += 1534;
            //    }

            //    LogMsg( LOG_DEBUG, "BRJ GetData8 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
            ...
            //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
            //    dataDmp = &m_audioFrame.data[ 1 ][ 0 ];
            //    if( playFrameCnt == 1 )
            //    {
            //        dataDmp += 1534;
            //    }

            //    LogMsg( LOG_DEBUG, "BRJ GetData9 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
            //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
            //        dataDmp[ 6 ], dataDmp[ 7 ],
            //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
            //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
            ...
            //if( testPlayStarted )
            //{
            //    uint8_t * dataDmp = &pBuffer[ 0 ];
            //    if( playFrameCnt == 1 )
            //    {
            //        dataDmp += 1534;
            //    }

            //    LogMsg( LOG_DEBUG, "BRJ GetData10 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
            //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
            //        dataDmp[ 6 ], dataDmp[ 7 ],
            //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
            //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
            ...
            //    LogMsg( LOG_DEBUG, "BRJ GetData11 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
            //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
            //        dataDmp[ 6 ], dataDmp[ 7 ],
            //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
            //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
    ...
    if( !bytes )
    {
        ...
        //    LogMsg( LOG_DEBUG, "BRJ GetData1 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
        //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
        //        dataDmp[ 6 ], dataDmp[ 7 ],
        //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
        //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
        ...
        //    LogMsg( LOG_DEBUG, "BRJ GetData2 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
        //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
        //        dataDmp[ 6 ], dataDmp[ 7 ],
        //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
        //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
    ...
    *actualsize = ( m_nDecodedLen <= size ) ? m_nDecodedLen : size;
    if( *actualsize > 0 )
    {
        if( m_needConvert )
        {
            ...
            //    LogMsg( LOG_DEBUG, "BRJ GetData3 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
            //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
            //        dataDmp[ 6 ], dataDmp[ 7 ],
            //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
            //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
            ...
            //    LogMsg( LOG_DEBUG, "BRJ GetData4 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
            //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
            //        dataDmp[ 6 ], dataDmp[ 7 ],
            //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
            //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
            ...
            //if( bytes && testPlayStarted )
            //{
            //    uint8_t * dataDmp = pBuffer;
            //    if( playFrameCnt == 1 )
            //    {
            //        dataDmp += 1785 * 2 + 10;
            //    }

            //    LogMsg( LOG_DEBUG, "BRJ GetData5 %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X %2.2X frame %d\n",
            //        dataDmp[ 0 ], dataDmp[ 1 ], dataDmp[ 2 ], dataDmp[ 3 ], dataDmp[ 4 ], dataDmp[ 5 ],
            //        dataDmp[ 6 ], dataDmp[ 7 ],
            //        dataDmp[ 8 ], dataDmp[ 9 ], dataDmp[ 10 ], dataDmp[ 11 ], dataDmp[ 12 ], dataDmp[ 13 ],
            //        dataDmp[ 14 ], dataDmp[ 15 ], playFrameCnt );
