...
#else
#include "StaticDll.h"
class DllLibass : public StaticDll, public DllLibassInterface
{
public:
    DllLibass();
    DllLibass( const DllLibass& ) = default;
    DllLibass& operator=( const DllLibass& rhs );

    DllLibass( DllLibass&& );
    DllLibass& operator=( DllLibass&& );
