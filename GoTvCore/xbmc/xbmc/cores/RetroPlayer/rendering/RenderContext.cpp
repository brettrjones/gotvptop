...
#if defined(HAS_GLES) && !defined(TARGET_OS_ANDROID)
...
{
#if defined(HAVE_QT_GUI)
    CRenderSystemQt *rendering = dynamic_cast< CRenderSystemQt* >( m_rendering );
    if( rendering != nullptr )
        rendering->EnableGUIShader( (ESHADERMETHOD)TranslateShaderMethod( method ) );
#elif defined(HAS_GL)
...
{
#if defined(HAVE_QT_GUI)
    CRenderSystemQt *renderingQt = dynamic_cast< CRenderSystemQt* >( m_rendering );
    if( renderingQt != nullptr )
        return static_cast<int>(renderingQt->GUIShaderGetPos());
...
int CRenderContext::GUIShaderGetCoord0()
{
    ...
    CRenderSystemQt *renderingQt = dynamic_cast< CRenderSystemQt* >( m_rendering );
    if( renderingQt != nullptr )
        return static_cast< int >( renderingQt->GUIShaderGetCoord0());
...
int CRenderContext::GUIShaderGetUniCol()
{
    ...
    CRenderSystemQt *renderingQt = dynamic_cast< CRenderSystemQt* >( m_rendering );
    if( renderingQt != nullptr )
        return static_cast< int >( renderingQt->GUIShaderGetUniCol());
