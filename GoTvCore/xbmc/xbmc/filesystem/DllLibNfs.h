...
class DllLibNfs : public StaticDll, public DllLibNfsInterface
{
public:
    DllLibNfs();
    DllLibNfs( const DllLibNfs& ) = default;

    virtual void mount_free_export_list( struct exportnode *exports );
    virtual struct exportnode *mount_getexports( const char *server );
    virtual struct nfs_server_list *nfs_find_local_servers( void );
    virtual void   free_nfs_srvr_list( struct nfs_server_list *srv );
    virtual struct nfs_context *nfs_init_context( void );
    virtual void nfs_destroy_context( struct nfs_context *nfs );
    virtual uint64_t nfs_get_readmax( struct nfs_context *nfs );
    virtual uint64_t nfs_get_writemax( struct nfs_context *nfs );
    virtual char *nfs_get_error( struct nfs_context *nfs );
    virtual int nfs_close( struct nfs_context *nfs, struct nfsfh *nfsfh );
    virtual int nfs_fsync( struct nfs_context *nfs, struct nfsfh *nfsfh );
    virtual int nfs_mkdir( struct nfs_context *nfs, const char *path );
    virtual int nfs_rmdir( struct nfs_context *nfs, const char *path );
    virtual int nfs_unlink( struct nfs_context *nfs, const char *path );
    virtual void nfs_closedir( struct nfs_context *nfs, struct nfsdir *nfsdir );
    virtual struct nfsdirent *nfs_readdir( struct nfs_context *nfs, struct nfsdir *nfsdir );
    virtual int nfs_mount( struct nfs_context *nfs, const char *server, const char *exportname );
    virtual int nfs_stat( struct nfs_context *nfs, const char *path, NFSSTAT *st );
    virtual int nfs_fstat( struct nfs_context *nfs, struct nfsfh *nfsfh, NFSSTAT *st );
    virtual int nfs_truncate( struct nfs_context *nfs, const char *path, uint64_t length );
    virtual int nfs_ftruncate( struct nfs_context *nfs, struct nfsfh *nfsfh, uint64_t length );
    virtual int nfs_opendir( struct nfs_context *nfs, const char *path, struct nfsdir **nfsdir );
    virtual int nfs_statvfs( struct nfs_context *nfs, const char *path, struct statvfs *svfs );
    virtual int nfs_chmod( struct nfs_context *nfs, const char *path, int mode );
    virtual int nfs_fchmod( struct nfs_context *nfs, struct nfsfh *nfsfh, int mode );
    virtual int nfs_access( struct nfs_context *nfs, const char *path, int mode );
    virtual int nfs_utimes( struct nfs_context *nfs, const char *path, struct timeval *times );
    virtual int nfs_utime( struct nfs_context *nfs, const char *path, struct utimbuf *times );
    virtual int nfs_symlink( struct nfs_context *nfs, const char *oldpath, const char *newpath );
    virtual int nfs_rename( struct nfs_context *nfs, const char *oldpath, const char *newpath );
    virtual int nfs_link( struct nfs_context *nfs, const char *oldpath, const char *newpath );
    virtual int nfs_readlink( struct nfs_context *nfs, const char *path, char *buf, int bufsize );
    virtual int nfs_chown( struct nfs_context *nfs, const char *path, int uid, int gid );
    virtual int nfs_fchown( struct nfs_context *nfs, struct nfsfh *nfsfh, int uid, int gid );
    virtual int nfs_open( struct nfs_context *nfs, const char *path, int mode, struct nfsfh **nfsfh );
    virtual int nfs_read( struct nfs_context *nfs, struct nfsfh *nfsfh, uint64_t count, char *buf );
    virtual int nfs_write( struct nfs_context *nfs, struct nfsfh *nfsfh, uint64_t count, char *buf );
    virtual int nfs_creat( struct nfs_context *nfs, const char *path, int mode, struct nfsfh **nfsfh );
    virtual int nfs_pread( struct nfs_context *nfs, struct nfsfh *nfsfh, uint64_t offset, uint64_t count, char *buf );
    virtual int nfs_pwrite( struct nfs_context *nfs, struct nfsfh *nfsfh, uint64_t offset, uint64_t count, char *buf );
    virtual int nfs_lseek( struct nfs_context *nfs, struct nfsfh *nfsfh, uint64_t offset, int whence, uint64_t *current_offset );
};
