...
void CSpecialProtocol::SetAppAssetsPath( const std::string &dir )
{
    SetPath( "appassets", dir );
}

void CSpecialProtocol::SetAccountsPath( const std::string &dir )
{
    SetPath( "accounts", dir );
}

void CSpecialProtocol::SetUserXferPath( const std::string &dir )
{
    SetPath( "userxfer", dir );
}

void CSpecialProtocol::SetUserGroupPath( const std::string &dir )
{
    SetPath( "usergroup", dir );
}
