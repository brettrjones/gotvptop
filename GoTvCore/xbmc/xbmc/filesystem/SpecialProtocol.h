...
public:
  ...
  // For P2P
  static void SetAppDataPath( const std::string &dir );
  static void SetAppAssetsPath( const std::string &dir );
  static void SetAccountsPath( const std::string &dir );
  static void SetUserXferPath( const std::string &dir );
  static void SetUserGroupPath( const std::string &dir );
