...
// #ifdef HAS_DVD_DRIVE //NOTE: DVD drives are not supported
...
void CApplication::Preflight()
{
    ...
    setenv( CCompileInfo::GetHomeEnvName(), install_path.c_str(), 0 );
...
bool CApplication::PlayFile( CFileItem item, const std::string& player, bool bRestart )
{
    ...
    //BRJ FIXME options.preferStereo = CServiceBroker::GetSettingsComponent()->GetAdvancedSettings()->m_videoPreferStereoStream &&
