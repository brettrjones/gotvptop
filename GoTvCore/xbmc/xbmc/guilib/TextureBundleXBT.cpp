...
//BRJ static lib
 ...
 //#ifdef _DEBUG
 //# pragma comment(lib, "libzlibD.lib")
 //#else
...
{
    //if(  Filename != "c:/users/me/appdata/roaming/kodip2p/media/splash.jpg"	
    //    &&  Filename != "c:/users/me/appdata/roaming/kodip2p/media/splash.png"	)
    //{
    //      CLog::Log( LOGDEBUG, "%s - Getting File %s", __FUNCTION__, Filename.c_str() );
    //}
